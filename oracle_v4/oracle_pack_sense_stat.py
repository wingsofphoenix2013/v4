# oracle_pack_sense_stat.py — воркер PACK-sense: оценка «разделяющей силы» по pack_base+agg_type+agg_key (0..1), сглаживание по 10 прогонам
...
SMOOTH_HISTORY_N = 10           # сглаживание по текущему и ≤5 предыдущим
EPS = 1e-12
