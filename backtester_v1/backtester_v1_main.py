...
# 🔸 Адаптивный анализатор (слушает bt:analysis:adaptive:ready, пишет v2)
...
async def main():
    ...
    await asyncio.gather(
        ...
        run_safe_loop(lambda: run_bt_analysis_adaptive_worker(pg, redis), "BT_ANALYSIS_ADAPTIVE"),  # v2 бины
