...
# 🔸 Оркестратор аналитики сценариев
from bt_scenarios_analysis import run_bt_scenarios_analysis
...
async def main():
    ...
    await asyncio.gather(
        ...
        run_safe_loop(lambda: run_bt_scenarios_analysis(pg, redis), "BT_SCENARIOS_ANALYSIS"),
    )
