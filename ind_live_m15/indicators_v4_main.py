# indicators_v4_main.py — управляющий модуль: конфиг через Pub/Sub + m15 sequencer (LIVE→MW), без стримов/PG-записей
...
from m15_sequencer import run_m15_sequencer
...
async def main():
    ...
    log.debug("ind_live_v4: старт процесса (SEQ_M15)")
