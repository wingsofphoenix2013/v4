# live_mw_h1.py — live-расчёт MW h1 (trend/volatility/momentum/extremes) с использованием L1; публикация «минимального» JSON в ind_mw_live:* (state + open_time; для trend — direction/strong; для volatility — atr_pct)
