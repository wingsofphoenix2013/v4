...
log = logging.getLogger("strategy_560_longst")

class Strategy560Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            for tf in tfs:
                ...
                # 2. Получаем winrate по pattern из Redis
            ...
            return True  # все таймфреймы прошли проверку

        except Exception:
            log.exception("❌ Ошибка в strategy_560_longst")
