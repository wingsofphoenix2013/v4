...
log = logging.getLogger("strategy_662_longst")

class Strategy662Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[662_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_662_longst")
