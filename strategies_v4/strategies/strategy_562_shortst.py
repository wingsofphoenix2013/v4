...
log = logging.getLogger("strategy_562_shortst")

class Strategy562Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[562_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_562_shortst")
