...
log = logging.getLogger("STRATEGY_321_LEVEL1")

class Strategy321Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[321] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[321:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_321_level1")
