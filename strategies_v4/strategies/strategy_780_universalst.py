...
log = logging.getLogger("strategy_780_universalst")

class Strategy780Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            # Проверка winrate по каждому tf и по двум объектам: snapshot и pattern
            for tf in tfs:
            ...
            log.exception("❌ Ошибка в strategy_780_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [780] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [780] Ошибка при отправке сигнала: {e}")