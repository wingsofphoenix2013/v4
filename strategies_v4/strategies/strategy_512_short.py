# strategy_512_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_512_short")

class Strategy512Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[512_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_512_universal_shortonly")
