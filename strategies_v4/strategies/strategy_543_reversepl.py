# strategy_543_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_543_REVERSEPL")

class Strategy543Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [543 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
