...
log = logging.getLogger("strategy_080_universalst")

class Strategy080Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Необработанная ошибка в strategy_080_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [080] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [080] Ошибка при отправке сигнала: {e}")