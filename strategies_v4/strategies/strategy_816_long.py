# strategy_816_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_816_long")

class Strategy816Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[816_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_816_universal_longonly")
