# strategy_433_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_433_REVERSEPL")

class Strategy433Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [433 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
