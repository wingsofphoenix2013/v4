...
log = logging.getLogger("strategy_680_universalst")

class Strategy680Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Необработанная ошибка в strategy_680_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [680] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [680] Ошибка при отправке сигнала: {e}")