# strategy_568_reverse.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_568_REVERSE")

class Strategy568Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [568 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, "
