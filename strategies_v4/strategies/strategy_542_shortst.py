...
log = logging.getLogger("strategy_542_shortst")

class Strategy542Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[542_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_542_shortst")
