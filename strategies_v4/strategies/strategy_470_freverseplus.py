# strategy_470_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_470_FREVERSEPLUS")

class Strategy470Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [420 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
