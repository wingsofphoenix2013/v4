...
log = logging.getLogger("STRATEGY_256_LEVEL2")

class Strategy256Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[256] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[256:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_256_level2")
