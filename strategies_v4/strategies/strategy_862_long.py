...
log = logging.getLogger("strategy_862_long")

class Strategy862Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[862_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_862_long")
