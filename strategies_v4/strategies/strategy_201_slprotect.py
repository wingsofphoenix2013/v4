# strategy_201_slprotect.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_201_SLPROTECT")

class Strategy201Slprotect:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [201 SLPROTECT] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
