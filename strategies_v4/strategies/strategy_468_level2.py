...
log = logging.getLogger("STRATEGY_468_LEVEL2")

class Strategy468Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[468] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[468:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_468_level2")
