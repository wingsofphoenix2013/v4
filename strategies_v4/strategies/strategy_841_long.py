...
log = logging.getLogger("strategy_841_long")

class Strategy841Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[841_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_841_long")
