...
log = logging.getLogger("strategy_891_longmwema3")

class Strategy891Longmwema3:
    async def validate_signal(self, signal, context):
        ...
        # ── Шаг 2: EMA200 triplet (live) m5-m15-h1 и его oracle-агрегат
        ...
        ema_key = f"oracle:emastat:comp:{base_id}:long:200:{triplet}"
        try:
