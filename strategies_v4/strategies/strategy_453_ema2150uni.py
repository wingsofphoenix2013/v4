# strategy_453_ema2150uni.py — 🔸 Универсальная стратегия (EMA21 + EMA50): два posfeat-триплета подряд, ORACLE пороги 0.2% / 0.55
...
log = logging.getLogger("strategy_453_ema2150uni")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy453Ema2150uni:
