# strategy_612_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_612_long")

class Strategy612Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[612_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_612_universal_longonly")
