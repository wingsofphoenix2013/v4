# strategy_267_slprotect.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_267_SLPROTECT")

class Strategy267Slprotect:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [267 SLPROTECT] symbol={symbol}, direction={direction}, tf={tf}, "
            ...
            if direction == "long":
                ...
                if rsi < 30 and mfi < 30 and price < bb_limit:
                    return True
                ...
                if rsi > 70 and mfi > 70 and price > bb_limit:
                    return True
