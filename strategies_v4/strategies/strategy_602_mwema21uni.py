# strategy_602_mwema21uni.py — 🔸 Универсальная стратегия (MW×EMA21 квартет): live MW-триплет + posfeat m5 EMA21-status, ORACLE пороги 0.15% / 0.55
...
log = logging.getLogger("strategy_602_mwema21uni")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy602Mwema21uni:
