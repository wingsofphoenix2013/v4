...
log = logging.getLogger("strategy_772_short")

class Strategy772Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[772_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_772_short")
