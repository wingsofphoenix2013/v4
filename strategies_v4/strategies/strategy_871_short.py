...
log = logging.getLogger("strategy_871_short")

class Strategy871Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[871_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_871_short")
