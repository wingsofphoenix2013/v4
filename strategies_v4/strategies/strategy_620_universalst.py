...
log = logging.getLogger("strategy_620_universalst")

class Strategy620Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Необработанная ошибка в strategy_620_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [620] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [620] Ошибка при отправке сигнала: {e}")