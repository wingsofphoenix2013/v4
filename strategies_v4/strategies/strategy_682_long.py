...
log = logging.getLogger("strategy_682_long")

class Strategy682Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[682_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_682_long")
