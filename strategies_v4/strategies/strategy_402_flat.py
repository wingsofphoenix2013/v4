# strategy_402_flat.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_402_FLAT")

class Strategy402Flat:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [402 FLAT] symbol={symbol}, direction={direction}, tf={tf}, current_price={current_price}, ema21={ema21}, ema50={ema50}")
