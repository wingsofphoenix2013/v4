# strategy_328_reversepl0.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_328_REVERSEPL0")

class Strategy328Reversepl0:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [328 REVERSEPL0] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
