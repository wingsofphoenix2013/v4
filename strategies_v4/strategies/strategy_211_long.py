# strategy_211_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_211_long")

class Strategy211Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[211_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_211_long")
