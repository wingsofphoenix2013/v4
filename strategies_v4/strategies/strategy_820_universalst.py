...
log = logging.getLogger("strategy_820_universalst")

class Strategy820Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Ошибка в strategy_820_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [820] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [820] Ошибка при отправке сигнала: {e}")