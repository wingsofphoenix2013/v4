# strategy_501_longemapatm15.py — стратегия: разрешение по EMA-паттернам (только m15)
...
log = logging.getLogger("strategy_501_longemapatm15")
...
class Strategy501Longemapatm15:
