...
log = logging.getLogger("strategy_722_longst")

class Strategy722Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[722_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_722_longst")
