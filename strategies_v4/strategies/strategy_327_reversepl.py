# strategy_327_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_327_REVERSEPL")

class Strategy327Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [327 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
