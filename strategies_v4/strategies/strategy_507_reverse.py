# strategy_507_reverse.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_507_REVERSE")

class Strategy507Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [507 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, "
