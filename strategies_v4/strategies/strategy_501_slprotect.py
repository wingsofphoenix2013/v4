# strategy_501_slprotect.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_501_SLPROTECT")

class Strategy501Slprotect:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [501 SLPROTECT] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}")
