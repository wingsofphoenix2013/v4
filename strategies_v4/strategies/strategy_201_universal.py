# strategy_201_universal.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_201_universal")

# 🔸 Класс стратегии
class Strategy201Universal:
