# strategy_615_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_615_short")

class Strategy615Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[615_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_615_universal_shortonly")
