# strategy_623_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_623_long")

class Strategy623Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[623_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_623_universal_longonly")
