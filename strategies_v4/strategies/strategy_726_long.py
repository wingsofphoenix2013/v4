# strategy_726_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_726_long")

class Strategy726Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[726_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_726_universal_longonly")
