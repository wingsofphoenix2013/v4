# strategy_422_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_422_long")

class Strategy422Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[422_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_422_long")
