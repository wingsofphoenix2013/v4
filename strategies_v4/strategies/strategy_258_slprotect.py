# strategy_258_slprotect.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_258_SLPROTECT")

class Strategy258Slprotect:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [258 SLPROTECT] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
