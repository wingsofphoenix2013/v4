# strategy_204_shortm5m15h1.py — зеркальная стратегия (шорт; laboratory_v4 TF: m5m15h1; таймаут ожидания 90с; INFO-логи; запись ignore в signal_log_queue)
...
# 🔸 Логгер стратегии
log = logging.getLogger("strategy_204_shortm5m15h1")

# 🔸 Класс стратегии
class Strategy204Shortm5m15h1:
    ...
    async def run(self, signal, context):
        ...
        # режим принятия решения лабораторией: "mw_only" или "mw_then_pack" или "mw_and_pack"
        decision_mode = "pack_only"
