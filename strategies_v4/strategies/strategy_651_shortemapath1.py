# strategy_651_shortemapath1.py — стратегия: разрешение по EMA-паттернам (только h1, short)
...
log = logging.getLogger("strategy_651_shortemapath1")
...
class Strategy651Shortemapath1:
