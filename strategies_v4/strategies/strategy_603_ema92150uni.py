# strategy_603_ema92150uni.py — 🔸 Универсальная стратегия (EMA9 + EMA21 + EMA50): три posfeat-триплета подряд, ORACLE пороги 0.2% / 0.55
...
log = logging.getLogger("strategy_603_ema92150uni")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy603Ema92150uni:
