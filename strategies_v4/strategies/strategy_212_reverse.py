# strategy_212_reverse.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_212_REVERSE")

class Strategy212Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [212 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
