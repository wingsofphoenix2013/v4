...
log = logging.getLogger("STRATEGY_461_LEVEL2")

class Strategy461Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[461] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[461:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.debug(f"[461:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_461_level2")
