...
log = logging.getLogger("strategy_841_universalst")

class Strategy841Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Ошибка в strategy_841_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [841] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [841] Ошибка при отправке сигнала: {e}")