# strategy_332_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_332_REVERSEPL")

class Strategy332Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [332 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
