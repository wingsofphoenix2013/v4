...
log = logging.getLogger("strategy_720_universalst")

class Strategy720Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            # BB-фильтр только на последнем таймфрейме (m15)
            tf_bb = tfs[-1]
            ...
            log.exception("❌ Ошибка в strategy_720_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [720] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [720] Ошибка при отправке сигнала: {e}")