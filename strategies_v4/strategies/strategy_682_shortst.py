...
log = logging.getLogger("strategy_682_shortst")

class Strategy682Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[682_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_682_shortst")
