# strategy_257_slprotect.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_257_SLPROTECT")

class Strategy257Slprotect:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [257 SLPROTECT] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
