...
log = logging.getLogger("strategy_522_longst")

class Strategy522Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[522_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_522_longst")
