# strategy_622_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_622_short")

class Strategy622Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[622_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_622_universal_shortonly")
