# strategy_300_kama10emacross.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_300_KAMA10EMACROSS")

class Strategy300Kama10emacross:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [300 KAMA10EMACROSS] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
