# strategy_224_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_224_REVERSEPL")

class Strategy224Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [224 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}, adx={adx}")
