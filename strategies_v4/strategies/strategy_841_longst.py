...
log = logging.getLogger("strategy_841_longst")

class Strategy841Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[841_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_841_longst")
