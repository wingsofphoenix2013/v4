# strategy_512_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_512_universal")

class Strategy512Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[512] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_512_level1")
