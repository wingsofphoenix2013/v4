# strategy_103_universal.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_103_universal")

# 🔸 Класс стратегии
class Strategy103Universal:
