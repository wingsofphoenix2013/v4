...
log = logging.getLogger("strategy_691_longst")

class Strategy691Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[691_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_691_longst")
