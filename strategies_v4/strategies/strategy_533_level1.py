# strategy_533_level1.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_533_LEVEL1")

class Strategy533Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[533] symbol={symbol}, tf={tf}, direction={direction}, price={price}, mfi={mfi}")
            ...
            log.exception("❌ Ошибка в strategy_533_level1")
