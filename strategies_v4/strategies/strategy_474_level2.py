...
log = logging.getLogger("STRATEGY_474_LEVEL2")

class Strategy474Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[474] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[474:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.debug(f"[474:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_474_level2")
