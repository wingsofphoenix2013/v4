# strategy_436_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_436_REVERSEPL")

class Strategy436Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [436 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
