# strategy_524_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_524_short")

class Strategy524Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[524_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_524_universal_shortonly")
