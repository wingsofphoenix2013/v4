# strategy_449_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_449_REVERSEPL")

class Strategy449Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [449 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
