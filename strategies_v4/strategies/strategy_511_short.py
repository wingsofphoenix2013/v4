...
class Strategy511Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[511_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_511_universal_shortonly")
