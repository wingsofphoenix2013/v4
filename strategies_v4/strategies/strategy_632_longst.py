...
log = logging.getLogger("strategy_632_longst")

class Strategy632Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[632_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_632_longst")
