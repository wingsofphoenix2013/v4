# strategy_751_longadx28h1.py — стратегия: разрешение по ADX (h1, length=28) через универсальный решатель
...
log = logging.getLogger("strategy_751_longadx28h1")
