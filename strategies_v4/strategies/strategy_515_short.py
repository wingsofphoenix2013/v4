# strategy_515_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_515_short")

class Strategy515Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[515_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_515_universal_shortonly")
