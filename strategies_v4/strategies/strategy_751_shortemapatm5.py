# strategy_751_shortemapatm5.py — стратегия: разрешение по EMA-паттернам (только m5, short)
...
log = logging.getLogger("strategy_751_shortemapatm5")
...
class Strategy751Shortemapatm5:
