...
log = logging.getLogger("STRATEGY_270_LEVEL1")

class Strategy270Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[270] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[270:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_270_level1")
