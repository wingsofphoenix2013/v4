# strategy_300_reversepl0.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_300_REVERSEPL0")

class Strategy300Reversepl0:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [300 REVERSEPL0] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
