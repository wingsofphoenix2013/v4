# strategy_505_slprotect.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_505_SLPROTECT")

class Strategy505Slprotect:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [505 SLPROTECT] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}")
