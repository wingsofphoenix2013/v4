# strategy_651_shortemapatm5.py — стратегия: разрешение по EMA-паттернам (только m5, short)
...
log = logging.getLogger("strategy_651_shortemapatm5")
...
class Strategy651Shortemapatm5:
