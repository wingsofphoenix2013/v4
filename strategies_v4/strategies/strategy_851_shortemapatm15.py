# strategy_851_shortemapatm15.py — стратегия: разрешение по EMA-паттернам (только m15, short)
...
log = logging.getLogger("strategy_851_shortemapatm15")
...
class Strategy851Shortemapatm15:
