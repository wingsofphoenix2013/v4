# strategy_323_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_323_FREVERSEPLUS")

class Strategy323Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [323 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
