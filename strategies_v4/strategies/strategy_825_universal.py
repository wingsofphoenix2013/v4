# strategy_825_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_825_universal")

class Strategy825Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[825] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_825_level1")
