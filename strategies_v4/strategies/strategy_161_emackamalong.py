...
log = logging.getLogger("strategy_161_emackamalong")

class Strategy161Emackamalong:
    async def validate_signal(self, signal, context):
        redis = context.get("redis")
        symbol = signal["symbol"]
        tf = "m5"  # таймфрейм
        tf_sec = 300  # секунд в баре для m5
        kama_length = 14  # длина KAMA — меняй здесь
        N = 4  # количество баров для расчёта наклона
        ...
        try:
            ...
            log.exception("Ошибка в strategy_161_emackamalong")
