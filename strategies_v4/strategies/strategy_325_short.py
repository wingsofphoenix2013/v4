# strategy_325_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_325_short")

class Strategy325Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[325_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_325_short")
