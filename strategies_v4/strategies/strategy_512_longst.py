...
log = logging.getLogger("strategy_512_longst")

class Strategy512Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[512_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_512_longst")
