# strategy_304_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_304_FREVERSEPLUS")

class Strategy304Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [304 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
