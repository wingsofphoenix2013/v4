# strategy_301_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_301_REVERSEPL")

class Strategy301Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [301 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}")
