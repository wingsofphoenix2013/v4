# strategy_311_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_311_universal")

class Strategy311Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[311] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
