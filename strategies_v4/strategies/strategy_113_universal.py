# strategy_113_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_113_universal")

class Strategy113Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[113] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_113_level1")
