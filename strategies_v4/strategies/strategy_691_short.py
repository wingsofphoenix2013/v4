...
log = logging.getLogger("strategy_691_short")

class Strategy691Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[691_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_691_short")
