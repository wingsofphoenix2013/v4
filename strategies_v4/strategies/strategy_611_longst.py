...
log = logging.getLogger("strategy_611_longst")

class Strategy611Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[611_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_611_longst")
