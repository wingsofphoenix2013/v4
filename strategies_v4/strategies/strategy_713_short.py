# strategy_713_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_713_short")

class Strategy713Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[713_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_713_universal_shortonly")
