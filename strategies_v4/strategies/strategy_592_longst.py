...
log = logging.getLogger("strategy_592_longst")

class Strategy592Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[592_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_592_longst")
