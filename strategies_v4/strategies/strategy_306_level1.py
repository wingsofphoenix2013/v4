...
log = logging.getLogger("STRATEGY_306_LEVEL1")

class Strategy306Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[306] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[306:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_306_level1")
