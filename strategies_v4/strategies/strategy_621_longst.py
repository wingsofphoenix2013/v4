...
log = logging.getLogger("strategy_621_longst")

class Strategy621Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[621_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_621_longst")
