# strategy_457_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_457_FREVERSEPLUS")

class Strategy457Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [407 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
