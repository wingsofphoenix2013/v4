...
log = logging.getLogger("strategy_872_short")

class Strategy872Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[872_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_872_short")
