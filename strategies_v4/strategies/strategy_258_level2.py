...
log = logging.getLogger("STRATEGY_258_LEVEL2")

class Strategy258Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[258] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[258:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_258_level2")
