# strategy_359_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_359_REVERSEPL")

class Strategy359Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [359 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
