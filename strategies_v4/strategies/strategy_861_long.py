...
log = logging.getLogger("strategy_861_long")

class Strategy861Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[861_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_861_long")
