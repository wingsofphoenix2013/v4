# strategy_214_flat.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_214_FLAT")

class Strategy214Flat:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [214 FLAT] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
