# strategy_106_universal.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_106_universal")

# 🔸 Класс стратегии
class Strategy106Universal:
