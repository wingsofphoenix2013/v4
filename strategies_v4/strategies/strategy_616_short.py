# strategy_616_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_616_short")

class Strategy616Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[616_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_616_universal_shortonly")
