# strategy_753_adxbbuni.py — 🔸 Универсальная стратегия (ADX-bin + BB-bin): два posfeat-триплета подряд, ORACLE пороги 0.2% / 0.55
...
log = logging.getLogger("strategy_753_adxbbuni")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy753Adxbbuni:
