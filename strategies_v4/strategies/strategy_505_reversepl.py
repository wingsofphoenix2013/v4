# strategy_505_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_505_REVERSEPL")

class Strategy505Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [505 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, price={price}, "
