...
log = logging.getLogger("strategy_682_short")

class Strategy682Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[682_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_682_short")
