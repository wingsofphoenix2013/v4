# strategy_213_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_213_universal")

class Strategy213Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[213] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_213_level1")
