...
log = logging.getLogger("STRATEGY_308_LEVEL2")

class Strategy308Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[308] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[308:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_308_level2")
