# strategy_501_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_501_REVERSEPL")

class Strategy501Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [501 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}")
