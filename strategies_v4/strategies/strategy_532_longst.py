...
log = logging.getLogger("strategy_532_longst")

class Strategy532Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[532_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_532_longst")
