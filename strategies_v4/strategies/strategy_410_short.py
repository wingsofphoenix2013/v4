# strategy_410_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_410_short")

class Strategy410Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[410_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_410_short")
