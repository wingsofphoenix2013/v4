# strategy_624_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_624_short")

class Strategy624Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[624_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_624_universal_shortonly")
