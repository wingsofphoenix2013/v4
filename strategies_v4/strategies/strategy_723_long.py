# strategy_723_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_723_long")

class Strategy723Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[723_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
