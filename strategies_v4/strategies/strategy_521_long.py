...
log = logging.getLogger("strategy_521_long")

class Strategy521Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[521_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_521_long")
