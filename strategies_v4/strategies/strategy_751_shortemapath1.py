# strategy_751_shortemapath1.py — стратегия: разрешение по EMA-паттернам (только h1, short)
...
log = logging.getLogger("strategy_751_shortemapath1")
...
class Strategy751Shortemapath1:
