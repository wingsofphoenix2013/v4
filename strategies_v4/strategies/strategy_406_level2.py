...
log = logging.getLogger("STRATEGY_406_LEVEL2")

class Strategy406Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[406] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[406:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_406_level2")
