...
log = logging.getLogger("strategy_761_shortst")

class Strategy761Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[761_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_761_shortst")
