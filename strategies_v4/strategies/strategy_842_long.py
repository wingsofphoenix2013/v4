...
log = logging.getLogger("strategy_842_long")

class Strategy842Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[842_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_842_long")
