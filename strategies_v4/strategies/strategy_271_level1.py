...
log = logging.getLogger("STRATEGY_271_LEVEL1")

class Strategy271Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[271] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[271:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_271_level1")
