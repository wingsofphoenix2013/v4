# strategy_824_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_824_universal")

class Strategy824Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[824] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_824_level1")
