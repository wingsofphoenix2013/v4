# strategy_711_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_711_short")

class Strategy711Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[711_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_711_universal_shortonly")
