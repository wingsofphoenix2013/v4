# strategy_751_shortadx14m15.py — стратегия: разрешение по ADX (m15, length=14) через универсальный решатель
...
log = logging.getLogger("strategy_751_shortadx14m15")
...
class Strategy751Shortadx14m15:
