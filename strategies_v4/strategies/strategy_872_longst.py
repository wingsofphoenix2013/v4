...
log = logging.getLogger("strategy_872_longst")

class Strategy872Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[872_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_872_longst")
