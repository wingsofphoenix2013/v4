# strategy_100_universal.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_100_universal")

# 🔸 Класс стратегии
class Strategy100Universal:
