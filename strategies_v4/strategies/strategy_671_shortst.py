...
log = logging.getLogger("strategy_671_shortst")

class Strategy671Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[671_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_671_shortst")
