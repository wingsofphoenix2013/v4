# strategy_511_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_511_long")

class Strategy511Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[511_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_511_universal_longonly")
