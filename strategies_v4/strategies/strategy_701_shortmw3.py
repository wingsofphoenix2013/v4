# strategy_701_shortmw3.py
import logging
import json

log = logging.getLogger("strategy_701_shortmw3")

class Strategy701Shortmw3:
    async def validate_signal(self, signal, context):
        ...
        # 1) читаем текущие regime9_code по трём ТФ
        try:
        ...
        # 3) читаем статистику marketwatcher по текущему marker3_code для SHORT
        key = f"oracle:mw:stat:{base_id}:short:{marker3_code}"
        try:
