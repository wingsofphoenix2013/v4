# strategy_548_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_548_REVERSEPL")

class Strategy548Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [548 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
