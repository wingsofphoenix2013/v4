# strategy_546_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_546_REVERSEPL")

class Strategy546Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [546 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
