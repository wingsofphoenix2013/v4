...
log = logging.getLogger("strategy_521_shortst")

class Strategy521Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[521_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_521_shortst")
