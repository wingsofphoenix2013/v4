...
log = logging.getLogger("strategy_711_longst")

class Strategy711Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[711_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_711_longst")
