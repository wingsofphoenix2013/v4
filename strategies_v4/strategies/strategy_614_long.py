# strategy_614_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_614_long")

class Strategy614Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[614_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_614_universal_longonly")
