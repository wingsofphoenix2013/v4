# strategy_204_universal.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_204_universal")

# 🔸 Класс стратегии
class Strategy204Universal:
