# strategy_528_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_528_REVERSEPL")

class Strategy528Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [528 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
