...
log = logging.getLogger("strategy_860_universalst")

class Strategy860Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Ошибка в strategy_860_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [860] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [860] Ошибка при отправке сигнала: {e}")