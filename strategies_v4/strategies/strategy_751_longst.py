...
log = logging.getLogger("strategy_751_longst")

class Strategy751Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[751_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_751_longst")
