...
log = logging.getLogger("strategy_591_longst")

class Strategy591Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[591_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_591_longst")
