# strategy_310_reverse.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_310_reverse")

# 🔸 Класс стратегии
class Strategy310Reverse:
