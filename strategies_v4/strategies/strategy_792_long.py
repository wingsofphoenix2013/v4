...
log = logging.getLogger("strategy_792_long")

class Strategy792Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[792_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_792_long")
