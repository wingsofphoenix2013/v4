...
log = logging.getLogger("STRATEGY_359_LEVEL2")

class Strategy359Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[359] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[359:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_359_level2")
