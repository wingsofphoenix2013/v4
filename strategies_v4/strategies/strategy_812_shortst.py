...
log = logging.getLogger("strategy_812_shortst")

class Strategy812Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[812_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_812_shortst")
