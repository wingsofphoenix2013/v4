...
log = logging.getLogger("strategy_821_longst")

class Strategy821Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[821_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_821_longst")
