...
log = logging.getLogger("strategy_692_longst")

class Strategy692Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[692_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_692_longst")
