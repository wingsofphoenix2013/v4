...
log = logging.getLogger("strategy_831_universalst")

class Strategy831Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Ошибка в strategy_831_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [831] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [831] Ошибка при отправке сигнала: {e}")