...
log = logging.getLogger("strategy_791_short")

class Strategy791Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[791_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_791_short")
