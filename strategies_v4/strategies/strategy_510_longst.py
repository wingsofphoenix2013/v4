...
log = logging.getLogger("strategy_510_longst")

class Strategy510Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            # 2. Получаем winrate по snapshot из Redis
            conf_key = f"confidence:{strategy_id}:longst:{tf}:snapshot:{snapshot_id}"
            ...
            log.exception("❌ Ошибка в strategy_510_longst")
