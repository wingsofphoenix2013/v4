...
log = logging.getLogger("strategy_561_longst")

class Strategy561Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[561_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_561_longst")
