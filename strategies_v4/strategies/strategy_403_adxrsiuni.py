# strategy_403_adxrsiuni.py — 🔸 Универсальная стратегия (ADX-bin + RSI14-bin): два posfeat-триплета подряд, ORACLE пороги 0.2% / 0.55
...
log = logging.getLogger("strategy_403_adxrsiuni")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy403Adxrsiuni:
