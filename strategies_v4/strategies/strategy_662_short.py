...
log = logging.getLogger("strategy_662_short")

class Strategy662Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[662_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_662_short")
