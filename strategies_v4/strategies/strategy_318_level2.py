...
log = logging.getLogger("STRATEGY_318_LEVEL2")

class Strategy318Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[318] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[318:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_318_level2")
