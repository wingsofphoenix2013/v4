...
log = logging.getLogger("strategy_831_longst")

class Strategy831Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[831_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_831_longst")
