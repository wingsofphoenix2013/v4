...
log = logging.getLogger("STRATEGY_418_LEVEL1")

class Strategy418Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[418] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[418:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_418_level1")
