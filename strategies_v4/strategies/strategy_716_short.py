# strategy_716_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_716_short")

class Strategy716Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[716_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_716_universal_shortonly")
