...
log = logging.getLogger("strategy_631_universalst")

class Strategy631Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Необработанная ошибка в strategy_631_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [631] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [631] Ошибка при отправке сигнала: {e}")