# strategy_435_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_435_REVERSEPL")

class Strategy435Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [435 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
