# strategy_303_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_303_REVERSEPL")

class Strategy303Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [303 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")

            if adx is None or rsi is None:
                return ("ignore", "нет значений ADX или RSI")
