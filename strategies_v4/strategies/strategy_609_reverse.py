# strategy_609_reverse.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_609_reverse")

# 🔸 Класс стратегии
class Strategy609Reverse:
