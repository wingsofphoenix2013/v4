# strategy_264_level2.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_264_LEVEL2")

class Strategy264Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[264] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_264_level2")
