# strategy_516_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_516_universal")

class Strategy516Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[516] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_516_level1")
