...
log = logging.getLogger("strategy_632_shortst")

class Strategy632Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[632_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_632_shortst")
