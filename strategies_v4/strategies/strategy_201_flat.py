# strategy_201_flat.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_201_FLAT")

class Strategy201Flat:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [201 FLAT] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
