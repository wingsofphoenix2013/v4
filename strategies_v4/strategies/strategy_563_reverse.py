# strategy_563_reverse.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_563_REVERSE")

class Strategy563Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [563 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
