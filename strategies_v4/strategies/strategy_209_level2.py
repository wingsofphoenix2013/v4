...
log = logging.getLogger("STRATEGY_209_LEVEL2")

class Strategy209Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[209] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[209:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_209_level2")
