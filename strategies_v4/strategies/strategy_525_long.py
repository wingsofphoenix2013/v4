# strategy_525_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_525_long")

class Strategy525Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[525_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_525_universal_longonly")
