# strategy_626_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_626_short")

class Strategy626Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[626_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_626_universal_shortonly")
