# strategy_522_reverse.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_522_REVERSE")

class Strategy522Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [522 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
