# strategy_709_reverse.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_709_reverse")

# 🔸 Класс стратегии
class Strategy709Reverse:
