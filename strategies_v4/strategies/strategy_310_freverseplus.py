# strategy_310_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_310_FREVERSEPLUS")

class Strategy310Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [310 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
