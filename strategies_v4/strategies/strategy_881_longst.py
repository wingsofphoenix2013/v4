...
log = logging.getLogger("strategy_881_longst")

class Strategy881Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[881_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_881_longst")
