# strategy_312_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_312_REVERSEPL")

class Strategy312Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [312 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
