# strategy_500_reverse.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_500_reverse")

# 🔸 Класс стратегии
class Strategy500Reverse:
