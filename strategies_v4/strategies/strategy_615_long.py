# strategy_615_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_615_long")

class Strategy615Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[615_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_615_universal_longonly")
