...
log = logging.getLogger("STRATEGY_456_LEVEL2")

class Strategy456Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[456] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[456:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_456_level2")
