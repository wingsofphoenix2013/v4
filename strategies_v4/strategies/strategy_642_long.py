...
log = logging.getLogger("strategy_642_long")

class Strategy642Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[642_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_642_long")
