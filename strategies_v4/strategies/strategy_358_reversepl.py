# strategy_358_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_358_REVERSEPL")

class Strategy358Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [358 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
