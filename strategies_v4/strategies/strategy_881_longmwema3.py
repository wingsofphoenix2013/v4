...
log = logging.getLogger("strategy_881_longmwema3")

class Strategy881Longmwema3:
    async def validate_signal(self, signal, context):
        ...
        regime_key = f"oracle:mw:stat:{base_id}:long:{marker3_code}"
        ...
        # ── Шаг 2: EMA100 triplet (live) m5-m15-h1 и его oracle-агрегат
        ...
        ema_key = f"oracle:emastat:comp:{base_id}:long:100:{triplet}"
        try:
