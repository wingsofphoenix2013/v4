...
log = logging.getLogger("strategy_562_short")

class Strategy562Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[562_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_562_short")
