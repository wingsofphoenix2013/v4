# strategy_419_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_419_FREVERSEPLUS")

class Strategy419Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [219 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
