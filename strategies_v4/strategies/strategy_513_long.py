# strategy_513_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_513_long")

class Strategy513Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[513_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_513_universal_longonly")
