...
log = logging.getLogger("STRATEGY_362_LEVEL2")

class Strategy362Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[362] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[362:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.debug(f"[362:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_362_level2")
