# strategy_816_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_816_short")

class Strategy816Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[816_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_816_universal_shortonly")
