# strategy_822_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_822_universal")

class Strategy822Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[822] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_822_level1")
