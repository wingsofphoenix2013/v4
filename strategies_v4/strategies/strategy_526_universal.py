# strategy_526_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_526_universal")

class Strategy526Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[526] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_526_level1")
