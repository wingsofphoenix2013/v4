# strategy_815_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_815_short")

class Strategy815Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[815_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_815_universal_shortonly")
