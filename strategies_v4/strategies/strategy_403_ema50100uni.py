# strategy_403_ema50100uni.py — 🔸 Универсальная стратегия (EMA50 + EMA100): два posfeat-триплета подряд, ORACLE пороги 0.2% / 0.55
...
log = logging.getLogger("strategy_403_ema50100uni")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy403Ema50100uni:
