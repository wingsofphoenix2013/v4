...
log = logging.getLogger("strategy_652_shortst")

class Strategy652Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[652_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_652_shortst")
