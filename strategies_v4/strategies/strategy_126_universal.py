# strategy_126_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_126_universal")

class Strategy126Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[126] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_126_level1")
