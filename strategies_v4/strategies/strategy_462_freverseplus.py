# strategy_462_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_462_FREVERSEPLUS")

class Strategy462Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [412 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
