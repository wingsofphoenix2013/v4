# strategy_261_flat.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_261_FLAT")

class Strategy261Flat:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [261 FLAT] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
