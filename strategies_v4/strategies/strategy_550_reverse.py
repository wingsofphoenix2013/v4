# strategy_550_reverse.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_550_reverse")

# 🔸 Класс стратегии
class Strategy550Reverse:
