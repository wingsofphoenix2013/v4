# strategy_522_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_522_short")

class Strategy522Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[522_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_522_universal_shortonly")
