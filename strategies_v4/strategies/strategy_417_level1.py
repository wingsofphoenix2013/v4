...
log = logging.getLogger("STRATEGY_417_LEVEL1")

class Strategy417Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[417] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[417:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_417_level1")
