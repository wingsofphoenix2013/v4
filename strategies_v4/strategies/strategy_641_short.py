...
log = logging.getLogger("strategy_641_short")

class Strategy641Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[641_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_641_short")
