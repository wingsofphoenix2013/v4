...
log = logging.getLogger("strategy_831_short")

class Strategy831Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[831_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_831_short")
