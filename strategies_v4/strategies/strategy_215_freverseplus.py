# strategy_215_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_215_FREVERSEPLUS")

class Strategy215Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [215 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
