# strategy_753_adxdmigapuni.py — 🔸 Универсальная стратегия (ADX-bin + DMI-gap-bin): два posfeat-триплета подряд, ORACLE пороги 0.2% / 0.55
...
log = logging.getLogger("strategy_753_adxdmigapuni")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy753Adxdmigapuni:
