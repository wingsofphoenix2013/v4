# strategy_701_longemapath1.py — стратегия: разрешение по EMA-паттернам (только h1)
...
log = logging.getLogger("strategy_701_longemapath1")
