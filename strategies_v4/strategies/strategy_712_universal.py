# strategy_712_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_712_universal")

class Strategy712Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[712] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_712_level1")
