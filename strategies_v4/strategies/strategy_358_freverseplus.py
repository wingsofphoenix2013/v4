# strategy_358_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_358_FREVERSEPLUS")

class Strategy358Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [308 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
