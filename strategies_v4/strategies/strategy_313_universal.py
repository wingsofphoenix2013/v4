# strategy_313_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_313_universal")

class Strategy313Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[313] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_313_level1")
