# strategy_104_universal.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_104_universal")

# 🔸 Класс стратегии
class Strategy104Universal:
