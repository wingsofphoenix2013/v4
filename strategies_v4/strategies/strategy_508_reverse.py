# strategy_508_reverse.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_508_REVERSE")

class Strategy508Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [508 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, "
