# strategy_210_reverse.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_210_reverse")

# 🔸 Класс стратегии
class Strategy210Reverse:
