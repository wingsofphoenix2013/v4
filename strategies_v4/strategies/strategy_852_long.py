...
log = logging.getLogger("strategy_852_long")

class Strategy852Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[852_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_852_long")
