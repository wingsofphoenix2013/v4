...
log = logging.getLogger("strategy_811_shortst")

class Strategy811Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[811_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_811_shortst")
