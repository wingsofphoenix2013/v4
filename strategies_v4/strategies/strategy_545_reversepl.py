# strategy_545_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_545_REVERSEPL")

class Strategy545Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [545 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, price={price}, "
