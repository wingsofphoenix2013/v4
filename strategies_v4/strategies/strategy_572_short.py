...
log = logging.getLogger("strategy_572_short")

class Strategy572Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[572_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_572_short")
