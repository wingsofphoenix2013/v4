...
class Strategy822Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[822_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_822_universal_longonly")
