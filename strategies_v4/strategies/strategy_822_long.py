...
log = logging.getLogger("strategy_822_long")

class Strategy822Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[822_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_822_long")
