# strategy_510_universal.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_510_universal")

# 🔸 Класс стратегии
class Strategy510Universal:
