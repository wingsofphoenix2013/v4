# strategy_715_reverse.py — двунаправленная стратегия с LAB-гейтингом и выбором мастера по направлению (long/short)
...
# 🔸 Логгер
log = logging.getLogger("strategy_715_reverse")
