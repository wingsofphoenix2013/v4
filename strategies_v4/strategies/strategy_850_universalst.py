...
log = logging.getLogger("strategy_850_universalst")

class Strategy850Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            # Проверка winrate по каждому tf
            for tf in tfs:
                ...
                if pattern_id is None:
                    return ("ignore", f"❌ нет pattern_id в {snapshot_key}")
            ...
            log.exception("❌ Ошибка в strategy_850_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [850] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [850] Ошибка при отправке сигнала: {e}")