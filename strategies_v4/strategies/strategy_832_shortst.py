...
log = logging.getLogger("strategy_832_shortst")

class Strategy832Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[832_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_832_shortst")
