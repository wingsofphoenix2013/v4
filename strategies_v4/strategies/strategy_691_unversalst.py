...
log = logging.getLogger("strategy_691_universalst")

class Strategy691Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Необработанная ошибка в strategy_691_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [691] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [691] Ошибка при отправке сигнала: {e}")