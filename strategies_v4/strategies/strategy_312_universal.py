# strategy_312_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_312_universal")

class Strategy312Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[312] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
