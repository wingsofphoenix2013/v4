# strategy_526_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_526_short")

class Strategy526Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[526_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_526_universal_shortonly")
