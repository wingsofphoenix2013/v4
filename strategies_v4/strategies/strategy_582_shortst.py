...
log = logging.getLogger("strategy_582_shortst")

class Strategy582Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[582_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_582_shortst")
