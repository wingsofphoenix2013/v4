...
log = logging.getLogger("strategy_691_shortst")

class Strategy691Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[691_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_691_shortst")
