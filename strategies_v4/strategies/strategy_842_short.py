...
log = logging.getLogger("strategy_842_short")

class Strategy842Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[842_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_842_short")
