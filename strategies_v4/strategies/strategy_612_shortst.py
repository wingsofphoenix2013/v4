...
log = logging.getLogger("strategy_612_shortst")

class Strategy612Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[612_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_612_shortst")
