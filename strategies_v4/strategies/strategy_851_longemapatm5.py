# strategy_851_longemapatm5.py — стратегия: разрешение по EMA-паттернам (только m5)
...
log = logging.getLogger("strategy_851_longemapatm5")
...
async def _ask_ema_m5_decision(redis, strategy_id: int, symbol: str, direction: str) -> tuple[str, str]:
    ...
    payload = {
        ...
        "mirror": "auto",
        # один check: ema_pattern, только m5, всегда on_demand
        "checks": json.dumps([{
            "kind": "ema_pattern",
            "timeframes": ["m5"],
            "source": "on_demand"
