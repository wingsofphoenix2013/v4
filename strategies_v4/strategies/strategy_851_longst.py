...
log = logging.getLogger("strategy_851_longst")

class Strategy851Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[851_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_851_longst")
