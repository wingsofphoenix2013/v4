# strategy_724_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_724_long")

class Strategy724Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[724_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_724_universal_longonly")
