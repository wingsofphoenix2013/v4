...
log = logging.getLogger("strategy_711_shortst")

class Strategy711Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[711_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_711_shortst")
