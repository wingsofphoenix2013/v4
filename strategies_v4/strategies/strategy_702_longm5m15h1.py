# strategy_702_longm5m15h1.py — зеркальная стратегия (лонг; laboratory_v4 TF: m5 + m15 + h1; ожидание по last-id, таймаут 90с; INFO-логи; запись ignore в signal_log_queue)
...
# 🔸 Логгер стратегии
log = logging.getLogger("strategy_702_longm5m15h1")

# 🔸 Класс стратегии
class Strategy702Longm5m15h1:
