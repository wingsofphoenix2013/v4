# strategy_344_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_344_REVERSEPL")

class Strategy344Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [344 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
