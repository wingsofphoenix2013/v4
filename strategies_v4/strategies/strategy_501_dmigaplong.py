# strategy_501_dmigaplong.py — 🔸 Лонговая стратегия (DMI-gap bins): берём posfeat-комбо мастера, сверяем с ORACLE, пороги по направлению
...
log = logging.getLogger("strategy_501_dmigaplong")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy501Dmigaplong:
