# strategy_322_freversenostopmove.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_322_FREVERSENOSTOPMOVE")

class Strategy322Freversenostopmove:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [222 FREVERSENOSTOPMOVE] symbol={symbol}, direction={direction}, tf={tf}, "
