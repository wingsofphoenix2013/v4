...
log = logging.getLogger("STRATEGY_219_LEVEL1")

class Strategy219Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[219] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[219:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_219_level1")
