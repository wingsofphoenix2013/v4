...
log = logging.getLogger("strategy_882_long")

class Strategy882Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[882_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_882_long")
