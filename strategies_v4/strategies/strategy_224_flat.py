# strategy_224_flat.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_224_FLAT")

class Strategy224Flat:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [224 FLAT] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}, adx={adx}")
