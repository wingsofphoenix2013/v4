...
log = logging.getLogger("STRATEGY_371_LEVEL1")

class Strategy371Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[371] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[371:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_371_level1")
