# strategy_403_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_403_FREVERSEPLUS")

class Strategy403Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [203 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
