# strategy_572_level2.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_572_LEVEL2")

class Strategy572Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[572] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_572_level2")
