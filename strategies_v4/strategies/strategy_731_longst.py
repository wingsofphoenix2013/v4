...
log = logging.getLogger("strategy_731_longst")

class Strategy731Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[731_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_731_longst")
