# strategy_125_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_125_universal")

class Strategy125Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[125] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_125_level1")
