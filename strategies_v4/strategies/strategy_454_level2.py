...
log = logging.getLogger("STRATEGY_454_LEVEL2")

class Strategy454Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[454] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[454:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_454_level2")
