...
class Strategy721Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[721_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_721_universal_longonly")
