# strategy_813_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_813_short")

class Strategy813Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[813_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_813_universal_shortonly")
