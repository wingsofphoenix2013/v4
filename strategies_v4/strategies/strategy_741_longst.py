...
log = logging.getLogger("strategy_741_longst")

class Strategy741Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[741_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_741_longst")
