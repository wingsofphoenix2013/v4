# strategy_816_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_816_universal")

class Strategy816Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[816] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_816_level1")
