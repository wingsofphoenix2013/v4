# strategy_338_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_338_REVERSEPL")

class Strategy338Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [338 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
