# strategy_350_universal.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_350_universal")

# 🔸 Класс стратегии
class Strategy350Universal:
