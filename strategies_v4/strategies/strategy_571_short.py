...
log = logging.getLogger("strategy_571_short")

class Strategy571Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[571_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_571_short")
