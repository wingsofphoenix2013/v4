...
log = logging.getLogger("strategy_622_long")

class Strategy622Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[622_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_622_long")
