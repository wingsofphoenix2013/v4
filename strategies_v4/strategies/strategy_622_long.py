...
class Strategy622Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[622_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_622_universal_longonly")
