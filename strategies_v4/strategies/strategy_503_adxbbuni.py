# strategy_503_adxbbuni.py — 🔸 Универсальная стратегия (ADX-bin + BB-bin): два posfeat-триплета подряд, ORACLE пороги 0.2% / 0.55
...
log = logging.getLogger("strategy_503_adxbbuni")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy503Adxbbuni:
