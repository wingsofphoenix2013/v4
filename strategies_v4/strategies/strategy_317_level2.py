...
log = logging.getLogger("STRATEGY_317_LEVEL2")

class Strategy317Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[317] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[317:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_317_level2")
