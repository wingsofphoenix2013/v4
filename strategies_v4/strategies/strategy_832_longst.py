...
log = logging.getLogger("strategy_832_longst")

class Strategy832Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[832_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_832_longst")
