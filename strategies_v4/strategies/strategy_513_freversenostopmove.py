# strategy_513_freversenostopmove.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_513_FREVERSENOSTOPMOVE")

class Strategy513Freversenostopmove:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [213 FREVERSENOSTOPMOVE] symbol={symbol}, direction={direction}, tf={tf}, "
