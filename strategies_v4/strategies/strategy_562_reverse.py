# strategy_562_reverse.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_562_REVERSE")

class Strategy562Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [562 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
