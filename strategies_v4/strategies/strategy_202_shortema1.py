# strategy_202_shortema1.py — стратегия: разрешение по EMA-паттернам (только m5, short)
...
log = logging.getLogger("strategy_202_shortema1")

REQUEST_STREAM  = "decision_request"
RESPONSE_STREAM = "decision_response"
DECISION_TIMEOUT_MS = 15000  # мс
