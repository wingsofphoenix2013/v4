# strategy_346_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_346_REVERSEPL")

class Strategy346Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [346 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
