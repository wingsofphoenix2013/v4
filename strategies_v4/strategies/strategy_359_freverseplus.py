# strategy_359_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_359_FREVERSEPLUS")

class Strategy359Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [309 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
