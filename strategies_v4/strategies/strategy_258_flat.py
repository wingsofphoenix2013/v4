# strategy_258_flat.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_258_FLAT")

class Strategy258Flat:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [258 FLAT] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
