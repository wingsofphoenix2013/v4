# strategy_624_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_624_universal")

class Strategy624Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[624] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_624_level1")
