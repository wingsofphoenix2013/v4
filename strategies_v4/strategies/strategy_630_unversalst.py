...
log = logging.getLogger("strategy_630_universalst")

class Strategy630Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Необработанная ошибка в strategy_630_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [630] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [630] Ошибка при отправке сигнала: {e}")