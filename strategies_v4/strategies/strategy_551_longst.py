...
log = logging.getLogger("strategy_551_longst")

class Strategy551Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[551_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_551_longst")
