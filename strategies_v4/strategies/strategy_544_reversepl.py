# strategy_544_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_544_REVERSEPL")

class Strategy544Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [544 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
