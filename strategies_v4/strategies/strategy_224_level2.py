...
log = logging.getLogger("STRATEGY_224_LEVEL2")

class Strategy224Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[224] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[224:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.debug(f"[224:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_224_level2")
