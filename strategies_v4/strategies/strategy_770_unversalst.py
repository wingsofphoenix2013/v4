...
log = logging.getLogger("strategy_770_universalst")

class Strategy770Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Ошибка в strategy_770_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [770] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [770] Ошибка при отправке сигнала: {e}")