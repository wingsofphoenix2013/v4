# strategy_501_ema100uni.py — 🔸 Универсальная стратегия (EMA100 status): берём posfeat-комбо мастера, сверяем с ORACLE, пороги по направлению
...
log = logging.getLogger("strategy_501_ema100uni")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy501Ema100uni:
