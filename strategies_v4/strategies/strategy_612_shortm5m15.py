# strategy_612_shortm5m15.py — зеркальная стратегия (шорт; laboratory_v4 TF: m5,m15; ожидание по last-id, таймаут 90с; INFO-логи; запись ignore в signal_log_queue)
