# strategy_506_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_506_REVERSEPL")

class Strategy506Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [506 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
