# strategy_213_slprotect.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_213_SLPROTECT")

class Strategy213Slprotect:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [213 SLPROTECT] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
