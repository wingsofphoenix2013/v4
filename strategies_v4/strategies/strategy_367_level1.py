...
log = logging.getLogger("STRATEGY_367_LEVEL1")

class Strategy367Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[367] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[367:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_367_level1")
