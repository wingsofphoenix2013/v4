# strategy_601_shortm5m15h1.py — зеркальная стратегия (шорт; laboratory_v4 TF: m5,m15,h1; ожидание по last-id, таймаут 90с; INFO-логи; запись ignore в signal_log_queue)
