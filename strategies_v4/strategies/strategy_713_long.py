# strategy_713_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_713_long")

class Strategy713Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[713_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_713_universal_longonly")
