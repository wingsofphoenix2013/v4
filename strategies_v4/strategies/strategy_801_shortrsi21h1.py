# strategy_801_shortrsi21h1.py — стратегия: разрешение по RSI (h1, length=21) через универсальный решатель
...
log = logging.getLogger("strategy_801_shortrsi21h1")
