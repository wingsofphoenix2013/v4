...
log = logging.getLogger("strategy_124_emackamashort")

class Strategy124Emackamashort:
    async def validate_signal(self, signal, context):
        ...
        N = 7  # количество баров для расчёта наклона
        ...
        try:
            ...
            log.exception("Ошибка в strategy_124_emackamashort")
