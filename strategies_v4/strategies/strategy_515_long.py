# strategy_515_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_515_long")

class Strategy515Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[515_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_515_universal_longonly")
