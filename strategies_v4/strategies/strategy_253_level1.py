# strategy_253_level1.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_253_LEVEL1")

class Strategy253Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[253] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.exception("❌ Ошибка в strategy_253_level1")
