# strategy_625_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_625_long")

class Strategy625Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[625_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_625_universal_longonly")
