...
log = logging.getLogger("strategy_740_universalst")

class Strategy740Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Ошибка в strategy_740_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [740] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [740] Ошибка при отправке сигнала: {e}")