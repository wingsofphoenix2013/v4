# strategy_551_longemapatm5.py — стратегия: разрешение по EMA-паттернам (только m5)
...
log = logging.getLogger("strategy_551_longemapatm5")
