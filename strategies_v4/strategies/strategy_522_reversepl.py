# strategy_522_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_522_REVERSEPL")

class Strategy522Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [522 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
