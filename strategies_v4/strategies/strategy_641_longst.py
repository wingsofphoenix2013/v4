...
log = logging.getLogger("strategy_641_longst")

class Strategy641Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[641_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_641_longst")
