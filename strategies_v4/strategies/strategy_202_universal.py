# strategy_202_universal.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_202_universal")

# 🔸 Класс стратегии
class Strategy202Universal:
