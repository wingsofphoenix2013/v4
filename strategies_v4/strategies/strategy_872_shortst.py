...
log = logging.getLogger("strategy_872_shortst")

class Strategy872Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[872_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_872_shortst")
