...
log = logging.getLogger("strategy_592_short")

class Strategy592Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[592_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_592_short")
