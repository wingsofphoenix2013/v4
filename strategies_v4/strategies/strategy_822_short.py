# strategy_822_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_822_short")

class Strategy822Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[822_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_822_universal_shortonly")
