# strategy_802_mwuni.py — 🔸 Универсальная стратегия (MW regime9): собираем live-триплет m5-m15-h1, сверяем с ORACLE, пороги по направлению
...
log = logging.getLogger("strategy_802_mwuni")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy802Mwuni:
