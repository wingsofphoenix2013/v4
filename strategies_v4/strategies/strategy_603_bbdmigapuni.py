# strategy_603_bbdmigapuni.py — 🔸 Универсальная стратегия (BB-bin + DMI-gap-bin): два posfeat-триплета подряд, ORACLE пороги 0.2% / 0.55
...
log = logging.getLogger("strategy_603_bbdmigapuni")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy603Bbdmigapuni:
