...
log = logging.getLogger("strategy_811_universalst")

class Strategy811Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Ошибка в strategy_811_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [811] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [811] Ошибка при отправке сигнала: {e}")