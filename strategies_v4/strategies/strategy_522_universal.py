# strategy_522_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_522_universal")

class Strategy522Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[522] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_522_level1")
