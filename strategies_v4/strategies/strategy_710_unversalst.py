...
log = logging.getLogger("strategy_710_universalst")

class Strategy710Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Ошибка в strategy_710_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [710] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [710] Ошибка при отправке сигнала: {e}")