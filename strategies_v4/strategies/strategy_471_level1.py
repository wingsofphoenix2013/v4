...
log = logging.getLogger("STRATEGY_471_LEVEL1")

class Strategy471Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[471] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[471:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_471_level1")
