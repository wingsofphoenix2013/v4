# strategy_612_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_612_short")

class Strategy612Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[612_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_612_universal_shortonly")
