# strategy_419_freversenostopmove.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_419_FREVERSENOSTOPMOVE")

class Strategy419Freversenostopmove:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [219 FREVERSENOSTOPMOVE] symbol={symbol}, direction={direction}, tf={tf}, "
            ...
            if None in (rsi, bb_center, bb_upper, bb_lower, bb_upper_25, bb_lower_25):
                return ("ignore", "недостаточно данных RSI или BB")
