# strategy_201_level1.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_201_LEVEL1")

class Strategy201Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[201] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.exception("❌ Ошибка в strategy_201_level1")
