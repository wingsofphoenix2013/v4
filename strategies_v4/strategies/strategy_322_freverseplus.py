# strategy_322_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_322_FREVERSEPLUS")

class Strategy322Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [222 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
