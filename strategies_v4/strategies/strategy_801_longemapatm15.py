# strategy_801_longemapatm15.py — стратегия: разрешение по EMA-паттернам (только m15)
...
log = logging.getLogger("strategy_801_longemapatm15")
...
class Strategy801Longemapatm15:
