# strategy_568_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_568_REVERSEPL")

class Strategy568Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [568 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
