# strategy_612_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_612_universal")

class Strategy612Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[612] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_612_level1")
