...
log = logging.getLogger("strategy_581_longst")

class Strategy581Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[581_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_581_longst")
