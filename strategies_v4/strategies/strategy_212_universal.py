# strategy_212_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_212_universal")

class Strategy212Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[212] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
