# strategy_527_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_527_REVERSEPL")

class Strategy527Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [527 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
