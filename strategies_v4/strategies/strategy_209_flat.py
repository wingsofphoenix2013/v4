# strategy_209_flat.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_209_FLAT")

class Strategy209Flat:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [209 FLAT] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
