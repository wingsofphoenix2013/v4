...
log = logging.getLogger("strategy_821_shortst")

class Strategy821Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[821_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_821_shortst")
