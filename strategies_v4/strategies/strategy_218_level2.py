...
log = logging.getLogger("STRATEGY_218_LEVEL2")

class Strategy218Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[218] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[218:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_218_level2")
