# strategy_371_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_371_FREVERSEPLUS")

class Strategy371Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [321 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
