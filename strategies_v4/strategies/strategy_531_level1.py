# strategy_531_level1.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_531_LEVEL1")

class Strategy531Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[531] symbol={symbol}, tf={tf}, direction={direction}, price={price}, mfi={mfi}")
            ...
            log.exception("❌ Ошибка в strategy_531_level1")
