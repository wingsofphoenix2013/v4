...
log = logging.getLogger("strategy_831_shortst")

class Strategy831Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[831_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_831_shortst")
