# strategy_304_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_304_REVERSEPL")

class Strategy304Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [304 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
