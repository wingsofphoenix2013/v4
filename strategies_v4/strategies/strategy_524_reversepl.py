# strategy_524_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_524_REVERSEPL")

class Strategy524Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [524 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
