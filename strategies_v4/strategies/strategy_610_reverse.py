# strategy_610_reverse.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_610_reverse")

# 🔸 Класс стратегии
class Strategy610Reverse:
