# strategy_412_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_412_REVERSEPL")

class Strategy412Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [412 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
