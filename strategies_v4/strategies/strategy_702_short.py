# strategy_702_short.py — шортовая стратегия с LAB-гейтингом (mw_then_pack, v1, без BL)
...
# 🔸 Логгер
log = logging.getLogger("strategy_702_short")
...
LAB_DECISION_MODE = "mw_then_pack"    # mw_only | mw_then_pack | mw_and_pack | pack_only
LAB_VERSION = "v1"               # v1 | v2
LAB_USE_BL = "false"             # "true" | "false" (строкой)
LAB_WAIT_TIMEOUT_SEC = 90        # таймаут ожидания ответа

# 🔸 Класс стратегии
class Strategy702Short:
