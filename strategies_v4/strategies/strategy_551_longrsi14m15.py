# strategy_551_longrsi14m15.py — стратегия: разрешение по RSI (m15, length=14) через универсальный решатель
...
log = logging.getLogger("strategy_551_longrsi14m15")
