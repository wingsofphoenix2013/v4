...
log = logging.getLogger("strategy_892_shortst")

class Strategy892Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[892_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_892_shortst")
