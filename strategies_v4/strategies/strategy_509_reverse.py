# strategy_509_reverse.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_509_reverse")

# 🔸 Класс стратегии
class Strategy509Reverse:
