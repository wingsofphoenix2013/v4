...
log = logging.getLogger("strategy_761_universalst")

class Strategy761Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Ошибка в strategy_761_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [761] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [761] Ошибка при отправке сигнала: {e}")