# strategy_526_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_526_long")

class Strategy526Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[526_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_526_universal_longonly")
