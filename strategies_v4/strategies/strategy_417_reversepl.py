# strategy_417_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_417_REVERSEPL")

class Strategy417Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [417 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
