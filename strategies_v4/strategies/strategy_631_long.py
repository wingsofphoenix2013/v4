...
log = logging.getLogger("strategy_631_long")

class Strategy631Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[631_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_631_long")
