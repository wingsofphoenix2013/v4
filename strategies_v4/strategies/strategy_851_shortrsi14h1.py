# strategy_851_shortrsi14h1.py — стратегия: разрешение по RSI (h1, length=14) через универсальный решатель
...
log = logging.getLogger("strategy_851_shortrsi14h1")
