# strategy_330_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_330_REVERSEPL")

class Strategy330Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [330 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
                      f"adx={adx}, mfi={mfi}, macd={macd}, signal={macd_signal}")

            if None in (adx, mfi, macd, macd_signal):
                return ("ignore", "нет значений ADX, MFI или MACD")
