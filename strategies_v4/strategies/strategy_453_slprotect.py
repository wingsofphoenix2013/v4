# strategy_453_slprotect.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_453_SLPROTECT")

class Strategy453Slprotect:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(
                f"🔍 [453 SLPROTECT] symbol={symbol}, direction={direction}, tf={tf}, "
