...
log = logging.getLogger("strategy_542_short")

class Strategy542Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[542_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_542_short")
