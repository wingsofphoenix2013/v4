# strategy_401_shortrsi7m5.py — стратегия: разрешение по RSI (m5, length=7) через универсальный решатель
...
log = logging.getLogger("strategy_401_shortrsi7m5")
