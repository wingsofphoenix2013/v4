# strategy_124_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_124_long")

class Strategy124Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[124_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_124_long")
