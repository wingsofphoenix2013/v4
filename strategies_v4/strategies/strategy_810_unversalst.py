...
log = logging.getLogger("strategy_810_universalst")

class Strategy810Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Ошибка в strategy_810_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [810] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [810] Ошибка при отправке сигнала: {e}")