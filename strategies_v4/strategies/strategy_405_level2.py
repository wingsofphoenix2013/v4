...
log = logging.getLogger("STRATEGY_405_LEVEL2")

class Strategy405Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[405] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[405:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_405_level2")
