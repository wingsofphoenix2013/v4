# strategy_403_slprotect.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_403_SLPROTECT")

class Strategy403Slprotect:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(
                f"🔍 [403 SLPROTECT] symbol={symbol}, direction={direction}, tf={tf}, "
