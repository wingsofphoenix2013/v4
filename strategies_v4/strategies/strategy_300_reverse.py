# strategy_300_reverse.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_300_reverse")

# 🔸 Класс стратегии
class Strategy300Reverse:
