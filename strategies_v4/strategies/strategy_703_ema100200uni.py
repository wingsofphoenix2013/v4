# strategy_703_ema100200uni.py — 🔸 Универсальная стратегия (EMA100 + EMA200): два posfeat-триплета подряд, ORACLE пороги 0.2% / 0.55
...
log = logging.getLogger("strategy_703_ema100200uni")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy703Ema100200uni:
