...
log = logging.getLogger("strategy_741_shortst")

class Strategy741Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[741_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_741_shortst")
