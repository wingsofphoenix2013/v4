# strategy_257_flat.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_257_FLAT")

class Strategy257Flat:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [257 FLAT] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
