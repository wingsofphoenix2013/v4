...
log = logging.getLogger("strategy_891_shortst")

class Strategy891Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[891_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_891_shortst")
