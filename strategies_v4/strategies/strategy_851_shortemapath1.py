# strategy_851_shortemapath1.py — стратегия: разрешение по EMA-паттернам (только h1, short)
...
log = logging.getLogger("strategy_851_shortemapath1")
...
class Strategy851Shortemapath1:
