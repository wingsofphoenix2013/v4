...
log = logging.getLogger("strategy_511_shortst")

class Strategy511Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[511_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_511_shortst")
