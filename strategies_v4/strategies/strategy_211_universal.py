# strategy_211_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_211_universal")

class Strategy211Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[211] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
