# strategy_441_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_441_REVERSEPL")

class Strategy441Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [441 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
            ...
            if direction == "long":
                if ema21 > ema50 and price > ema21 and rsi > 45 and plus_di > minus_di:
                    return True
                return ("ignore", f"фильтр long не пройден: ema21={ema21}, ema50={ema50}, "
                                  f"price={price}, rsi={rsi}, DI+={plus_di}, DI-={minus_di}")

            elif direction == "short":
                if ema21 < ema50 and price < ema21 and rsi < 55 and minus_di > plus_di:
                    return True
