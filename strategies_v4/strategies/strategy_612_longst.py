...
log = logging.getLogger("strategy_612_longst")

class Strategy612Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[612_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_612_longst")
