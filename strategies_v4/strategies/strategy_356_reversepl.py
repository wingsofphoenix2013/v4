# strategy_356_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_356_REVERSEPL")

class Strategy356Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [356 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
