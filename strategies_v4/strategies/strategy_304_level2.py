...
log = logging.getLogger("STRATEGY_304_LEVEL2")

class Strategy304Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[304] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[304:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_304_level2")
