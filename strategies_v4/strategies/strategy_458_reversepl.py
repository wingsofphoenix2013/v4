# strategy_458_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_458_REVERSEPL")

class Strategy458Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [458 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
            ...
            if direction == "long":
                ...
                if price > ema21 and 50 <= rsi <= 70 and dmi_gap >= 5:
                    return True
                ...
                if price < ema21 and 30 <= rsi <= 50 and dmi_gap >= 5:
                    return True
