...
log = logging.getLogger("STRATEGY_310_LEVEL1")

class Strategy310Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[310] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[310:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.debug(f"[310:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_310_level1")
