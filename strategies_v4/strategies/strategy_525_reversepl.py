# strategy_525_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_525_REVERSEPL")

class Strategy525Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [525 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, price={price}, "
