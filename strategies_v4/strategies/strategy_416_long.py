# strategy_416_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_416_long")

class Strategy416Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[416_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_416_long")
