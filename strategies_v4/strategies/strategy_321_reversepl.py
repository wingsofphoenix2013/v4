# strategy_321_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_321_REVERSEPL")

class Strategy321Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [321 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}")
