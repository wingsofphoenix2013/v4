# strategy_812_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_812_short")

class Strategy812Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[812_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_812_universal_shortonly")
