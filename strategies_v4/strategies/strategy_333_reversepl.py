# strategy_333_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_333_REVERSEPL")

class Strategy333Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [333 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
