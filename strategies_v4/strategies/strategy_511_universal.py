# strategy_511_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_511_universal")

class Strategy511Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[511] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_511_level1")
