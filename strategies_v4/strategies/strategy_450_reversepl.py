# strategy_450_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_450_REVERSEPL")

class Strategy450Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [450 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
            ...
            if direction == "long":
                ...
                if price > ema21 and dmi_gap >= 5:
                    return True
                return ("ignore", f"фильтр long не пройден: price={price}, ema21={ema21}, gap={dmi_gap}")

            elif direction == "short":
                dmi_gap = minus_di - plus_di
                if price < ema21 and dmi_gap >= 5:
                    return True
                return ("ignore", f"фильтр short не пройден: price={price}, ema21={ema21}, gap={dmi_gap}")
