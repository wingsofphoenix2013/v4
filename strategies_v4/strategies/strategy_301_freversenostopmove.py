# strategy_301_freversenostopmove.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_301_FREVERSENOSTOPMOVE")

class Strategy301Freversenostopmove:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [201 FREVERSENOSTOPMOVE] symbol={symbol}, direction={direction}, tf={tf}, "
