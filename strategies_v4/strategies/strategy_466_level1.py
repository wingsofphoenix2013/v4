...
log = logging.getLogger("STRATEGY_466_LEVEL1")

class Strategy466Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[466] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[466:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_466_level1")
