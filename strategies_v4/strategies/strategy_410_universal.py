# strategy_410_universal.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_410_universal")

# 🔸 Класс стратегии
class Strategy410Universal:
