...
log = logging.getLogger("strategy_692_short")

class Strategy692Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[692_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_692_short")
