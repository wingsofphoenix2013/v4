...
log = logging.getLogger("strategy_861_longst")

class Strategy861Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[861_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_861_longst")
