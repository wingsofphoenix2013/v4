...
log = logging.getLogger("strategy_592_shortst")

class Strategy592Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[592_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_592_shortst")
