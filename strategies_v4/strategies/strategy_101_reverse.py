# strategy_101_reverse.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_101_reverse")

# 🔸 Класс стратегии
class Strategy101Reverse:
