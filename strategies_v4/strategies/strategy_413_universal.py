# strategy_413_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_413_universal")

class Strategy413Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[413] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_413_level1")
