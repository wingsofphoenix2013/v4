# strategy_312_longm5m15.py — зеркальная стратегия (лонг; laboratory_v4 TF: m5 + m15; ожидание по last-id, таймаут 90с; INFO-логи; запись ignore в signal_log_queue)
...
# 🔸 Логгер стратегии
log = logging.getLogger("strategy_312_longm5m15")

# 🔸 Класс стратегии
class Strategy312Longm5m15:
