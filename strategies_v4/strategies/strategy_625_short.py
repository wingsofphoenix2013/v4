# strategy_625_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_625_short")

class Strategy625Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[625_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_625_universal_shortonly")
