# strategy_318_reversepl0.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_318_REVERSEPL0")

class Strategy318Reversepl0:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [318 REVERSEPL0] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
