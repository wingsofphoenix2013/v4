# strategy_300_kama15emacross.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_300_KAMA15EMACROSS")

class Strategy300Kama15emacross:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [300 KAMA15EMACROSS] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
