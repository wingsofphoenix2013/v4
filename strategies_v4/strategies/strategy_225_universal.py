# strategy_225_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_225_universal")

class Strategy225Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[225] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_225_level1")
