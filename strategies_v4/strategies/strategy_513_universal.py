# strategy_513_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_513_universal")

class Strategy513Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[513] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_513_level1")
