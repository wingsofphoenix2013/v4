# strategy_214_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_214_universal")

class Strategy214Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[214] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_214_level1")
