...
log = logging.getLogger("STRATEGY_320_LEVEL2")

class Strategy320Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[320] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[320:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_320_level2")
