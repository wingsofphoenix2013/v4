...
log = logging.getLogger("strategy_622_longst")

class Strategy622Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[622_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_622_longst")
