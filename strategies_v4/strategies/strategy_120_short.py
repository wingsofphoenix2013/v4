# strategy_120_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_120_short")

class Strategy120Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[120_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_120_short")
