# strategy_337_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_337_REVERSEPL")

class Strategy337Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [337 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
