# strategy_342_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_342_REVERSEPL")

class Strategy342Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [342 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
