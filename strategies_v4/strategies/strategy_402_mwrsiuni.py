# strategy_402_mwrsiuni.py — 🔸 Универсальная стратегия (MW×RSI квартет): live MW-триплет + posfeat m5 RSI-bin, ORACLE пороги 0.15% / 0.55
...
log = logging.getLogger("strategy_402_mwrsiuni")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy402Mwrsiuni:
