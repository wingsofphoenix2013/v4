...
log = logging.getLogger("strategy_582_longst")

class Strategy582Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[582_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_582_longst")
