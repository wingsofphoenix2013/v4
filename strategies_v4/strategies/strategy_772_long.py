...
log = logging.getLogger("strategy_772_long")

class Strategy772Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[772_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_772_long")
