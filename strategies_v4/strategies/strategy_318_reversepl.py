# strategy_318_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_318_REVERSEPL")

class Strategy318Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [318 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
