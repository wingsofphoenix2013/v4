...
log = logging.getLogger("strategy_730_universalst")

class Strategy730Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Ошибка в strategy_730_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [730] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [730] Ошибка при отправке сигнала: {e}")