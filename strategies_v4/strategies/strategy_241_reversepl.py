# strategy_241_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_241_REVERSEPL")

class Strategy241Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [241 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
