...
log = logging.getLogger("strategy_750_universalst")

class Strategy750Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Ошибка в strategy_750_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [750] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [750] Ошибка при отправке сигнала: {e}")