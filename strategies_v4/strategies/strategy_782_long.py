...
log = logging.getLogger("strategy_782_long")

class Strategy782Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[782_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_782_long")
