# strategy_342_level1.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_342_LEVEL1")

class Strategy342Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[341] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_341_level1")
            return ("ignore", "ошибка в стратегии")
            
        except Exception:
            log.exception("❌ Ошибка в strategy_342_level1")
            return ("ignore", "ошибка в стратегии")
