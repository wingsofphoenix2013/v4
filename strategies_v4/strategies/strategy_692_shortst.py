...
log = logging.getLogger("strategy_692_shortst")

class Strategy692Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[692_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_692_shortst")
