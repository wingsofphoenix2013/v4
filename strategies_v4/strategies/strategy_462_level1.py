...
log = logging.getLogger("STRATEGY_462_LEVEL1")

class Strategy462Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[462] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[462:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.debug(f"[462:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_462_level1")
