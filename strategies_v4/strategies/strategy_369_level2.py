...
log = logging.getLogger("STRATEGY_369_LEVEL2")

class Strategy369Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[369] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[369:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_369_level2")
