...
log = logging.getLogger("STRATEGY_467_LEVEL2")

class Strategy467Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[467] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[467:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_467_level2")
