# strategy_726_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_726_universal")

class Strategy726Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[726] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_726_level1")
