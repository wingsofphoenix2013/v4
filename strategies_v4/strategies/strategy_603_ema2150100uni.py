# strategy_603_ema2150100uni.py — 🔸 Универсальная стратегия (EMA21 + EMA50 + EMA100): три posfeat-триплета подряд, ORACLE пороги 0.2% / 0.55
...
log = logging.getLogger("strategy_603_ema2150100uni")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy603Ema2150100uni:
