# strategy_200_universal.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_200_universal")

# 🔸 Класс стратегии
class Strategy200Universal:
