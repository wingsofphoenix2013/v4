# strategy_214_reverse.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_214_REVERSE")

class Strategy214Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [214 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
