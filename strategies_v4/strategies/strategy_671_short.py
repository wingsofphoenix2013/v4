...
log = logging.getLogger("strategy_671_short")

class Strategy671Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[671_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_671_short")
