# strategy_614_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_614_short")

class Strategy614Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[614_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_614_universal_shortonly")
