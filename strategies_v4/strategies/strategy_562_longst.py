...
log = logging.getLogger("strategy_562_longst")

class Strategy562Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[562_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_562_longst")
