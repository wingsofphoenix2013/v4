# strategy_261_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_261_REVERSEPL")

class Strategy261Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [261 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
