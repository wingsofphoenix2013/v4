...
log = logging.getLogger("strategy_621_long")

class Strategy621Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[621_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_621_long")
