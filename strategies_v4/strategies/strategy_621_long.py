...
class Strategy621Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[621_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_621_universal_longonly")
