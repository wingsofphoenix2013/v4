...
log = logging.getLogger("strategy_661_universalst")

class Strategy661Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Необработанная ошибка в strategy_661_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [661] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [661] Ошибка при отправке сигнала: {e}")