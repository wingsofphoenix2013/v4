# strategy_265_level2.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_265_LEVEL2")

class Strategy265Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[265] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_265_level2")
