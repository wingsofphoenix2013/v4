# strategy_328_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_328_REVERSEPL")

class Strategy328Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [328 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
