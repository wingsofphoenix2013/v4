# strategy_622_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_622_universal")

class Strategy622Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[622] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_622_level1")
