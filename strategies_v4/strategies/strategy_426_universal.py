# strategy_426_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_426_universal")

class Strategy426Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[426] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_426_level1")
