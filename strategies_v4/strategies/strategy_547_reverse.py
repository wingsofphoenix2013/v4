# strategy_547_reverse.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_547_REVERSE")

class Strategy547Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [547 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, "
