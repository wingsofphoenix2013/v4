# strategy_562_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_562_REVERSEPL")

class Strategy562Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [562 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
