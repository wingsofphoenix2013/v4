...
log = logging.getLogger("strategy_070_universalst")

class Strategy070Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Необработанная ошибка в strategy_070_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [070] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [070] Ошибка при отправке сигнала: {e}")