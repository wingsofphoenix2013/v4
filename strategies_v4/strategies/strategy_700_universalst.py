...
log = logging.getLogger("strategy_700_universalst")

class Strategy700Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Ошибка в strategy_700_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [700] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [700] Ошибка при отправке сигнала: {e}")