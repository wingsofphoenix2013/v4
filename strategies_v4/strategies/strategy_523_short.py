# strategy_523_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_523_short")

class Strategy523Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[523_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_523_universal_shortonly")
