# strategy_513_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_513_FREVERSEPLUS")

class Strategy513Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [213 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
