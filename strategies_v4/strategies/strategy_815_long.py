# strategy_815_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_815_long")

class Strategy815Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[815_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_815_universal_longonly")
