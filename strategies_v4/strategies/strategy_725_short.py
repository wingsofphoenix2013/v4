# strategy_725_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_725_short")

class Strategy725Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[725_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_725_universal_shortonly")
