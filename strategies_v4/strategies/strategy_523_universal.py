# strategy_523_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_523_universal")

class Strategy523Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[523] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_523_level1")
