...
log = logging.getLogger("strategy_882_shortst")

class Strategy882Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[882_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_882_shortst")
