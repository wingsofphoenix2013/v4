...
log = logging.getLogger("STRATEGY_210_LEVEL2")

class Strategy210Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[210] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[210:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.debug(f"[210:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_210_level2")
