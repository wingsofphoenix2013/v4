# strategy_524_freversenostopmove.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_524_FREVERSENOSTOPMOVE")

class Strategy524Freversenostopmove:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [224 FREVERSENOSTOPMOVE] symbol={symbol}, direction={direction}, tf={tf}, "
