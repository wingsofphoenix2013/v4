# strategy_126_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_126_long")

class Strategy126Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[126_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_126_long")
