...
log = logging.getLogger("STRATEGY_469_LEVEL1")

class Strategy469Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[469] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[469:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_469_level1")
