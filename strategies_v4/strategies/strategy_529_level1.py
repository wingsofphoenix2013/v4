# strategy_529_level1.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_529_LEVEL1")

class Strategy529Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[529] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_529_level1")
