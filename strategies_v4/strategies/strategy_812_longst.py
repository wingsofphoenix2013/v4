...
log = logging.getLogger("strategy_812_longst")

class Strategy812Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[812_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_812_longst")
