...
log = logging.getLogger("strategy_881_short")

class Strategy881Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[881_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_881_short")
