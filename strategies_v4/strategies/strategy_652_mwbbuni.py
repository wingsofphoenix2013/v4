# strategy_652_mwbbuni.py — 🔸 Универсальная стратегия (MW×BB квартет): live MW-триплет + posfeat m5 BB-bin, ORACLE пороги 0.15% / 0.55
...
log = logging.getLogger("strategy_652_mwbbuni")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy652Mwbbuni:
