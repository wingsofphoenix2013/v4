...
log = logging.getLogger("strategy_581_shortst")

class Strategy581Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[581_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_581_shortst")
