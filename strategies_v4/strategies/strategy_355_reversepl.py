# strategy_355_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_355_REVERSEPL")

class Strategy355Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [355 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
