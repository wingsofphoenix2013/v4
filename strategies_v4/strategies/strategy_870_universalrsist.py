...
log = logging.getLogger("strategy_870_universalrsist")

class Strategy870Universalrsist:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            # Получаем snapshot_id и pattern_id
            ...
            # Проверка snapshot_rsi и pattern_rsi
            ...
            if verdict_snap != "allow":
                return ("ignore", f"Snapshot RSI-check verdict={verdict_snap}")
            if verdict_pat != "allow":
                return ("ignore", f"Pattern RSI-check verdict={verdict_pat}")

            # Дополнительная проверка BB
            ...
            log.exception("Ошибка в strategy_870_universalrsist")
