# strategy_523_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_523_FREVERSEPLUS")

class Strategy523Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [523 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
