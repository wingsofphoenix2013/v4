# strategy_516_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_516_short")

class Strategy516Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[516_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_516_universal_shortonly")
