# strategy_317_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_317_REVERSEPL")

class Strategy317Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [317 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
