...
log = logging.getLogger("strategy_861_shortst")

class Strategy861Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[861_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_861_shortst")
