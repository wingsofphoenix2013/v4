...
log = logging.getLogger("strategy_572_long")

class Strategy572Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[572_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_572_long")
