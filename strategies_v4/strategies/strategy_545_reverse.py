# strategy_545_reverse.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_545_REVERSE")

class Strategy545Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [545 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, price={price}, "
