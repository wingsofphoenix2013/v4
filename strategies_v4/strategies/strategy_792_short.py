...
log = logging.getLogger("strategy_792_short")

class Strategy792Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[792_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_792_short")
