# strategy_752_mwema21uni.py — 🔸 Универсальная стратегия (MW×EMA21 квартет): live MW-триплет + posfeat m5 EMA21-status, ORACLE пороги 0.15% / 0.55
...
log = logging.getLogger("strategy_752_mwema21uni")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy752Mwema21uni:
