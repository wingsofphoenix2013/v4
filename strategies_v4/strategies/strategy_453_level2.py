# strategy_453_level2.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_453_LEVEL2")

class Strategy453Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[453] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.exception("❌ Ошибка в strategy_453_level2")
