# strategy_528_reverse.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_528_REVERSE")

class Strategy528Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [528 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, "
