...
log = logging.getLogger("strategy_742_long")

class Strategy742Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[742_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_742_long")
