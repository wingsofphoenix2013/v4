# strategy_501_shortemapatm5.py — стратегия: разрешение по EMA-паттернам (только m5, short)
...
log = logging.getLogger("strategy_501_shortemapatm5")
...
class Strategy501Shortemapatm5:
