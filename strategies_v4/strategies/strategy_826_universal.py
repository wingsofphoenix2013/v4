# strategy_826_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_826_universal")

class Strategy826Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[826] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_826_level1")
