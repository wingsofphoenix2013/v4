# strategy_357_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_357_REVERSEPL")

class Strategy357Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [357 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
