...
log = logging.getLogger("STRATEGY_416_LEVEL2")

class Strategy416Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[416] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[416:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_416_level2")
