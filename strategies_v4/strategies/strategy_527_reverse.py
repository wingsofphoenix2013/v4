# strategy_527_reverse.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_527_REVERSE")

class Strategy527Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [527 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, "
