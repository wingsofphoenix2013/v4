# strategy_451_dmigapuni.py — 🔸 Универсальная стратегия (DMI-gap bins): берём posfeat-комбо мастера, сверяем с ORACLE, пороги по направлению
...
log = logging.getLogger("strategy_451_dmigapuni")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy451Dmigapuni:
