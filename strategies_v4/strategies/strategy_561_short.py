...
log = logging.getLogger("strategy_561_short")

class Strategy561Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[561_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_561_short")
