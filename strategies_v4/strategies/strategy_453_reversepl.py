# strategy_453_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_453_REVERSEPL")

class Strategy453Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [453 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
