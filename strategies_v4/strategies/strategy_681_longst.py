...
log = logging.getLogger("strategy_681_longst")

class Strategy681Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[681_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_681_longst")
