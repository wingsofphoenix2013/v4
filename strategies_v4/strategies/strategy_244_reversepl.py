# strategy_244_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_244_REVERSEPL")

class Strategy244Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [244 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}, adx={adx}")
