# strategy_824_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_824_long")

class Strategy824Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[824_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_824_universal_longonly")
