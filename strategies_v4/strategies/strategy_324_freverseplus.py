# strategy_324_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_324_FREVERSEPLUS")

class Strategy324Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [224 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
