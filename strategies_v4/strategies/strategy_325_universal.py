# strategy_325_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_325_universal")

class Strategy325Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[325] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_325_level1")
