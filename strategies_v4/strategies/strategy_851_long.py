...
log = logging.getLogger("strategy_851_long")

class Strategy851Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[851_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_851_long")
