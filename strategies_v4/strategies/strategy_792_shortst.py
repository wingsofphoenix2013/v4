...
log = logging.getLogger("strategy_792_shortst")

class Strategy792Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[792_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_792_shortst")
