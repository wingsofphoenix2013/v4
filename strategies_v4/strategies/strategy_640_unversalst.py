...
log = logging.getLogger("strategy_640_universalst")

class Strategy640Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Необработанная ошибка в strategy_640_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [640] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [640] Ошибка при отправке сигнала: {e}")