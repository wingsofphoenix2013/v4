# strategy_409_reverse.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_409_reverse")

# 🔸 Класс стратегии
class Strategy409Reverse:
