...
log = logging.getLogger("strategy_561_shortst")

class Strategy561Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[561_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_561_shortst")
