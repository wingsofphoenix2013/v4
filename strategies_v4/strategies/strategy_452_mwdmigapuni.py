# strategy_452_mwdmigapuni.py — 🔸 Универсальная стратегия (MW×DMI-gap квартет): live MW-триплет + posfeat m5 DMI-gap bin, ORACLE пороги 0.15% / 0.55
...
log = logging.getLogger("strategy_452_mwdmigapuni")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy452Mwdmigapuni:
