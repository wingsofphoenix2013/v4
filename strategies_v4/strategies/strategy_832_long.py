...
log = logging.getLogger("strategy_832_long")

class Strategy832Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[832_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_832_long")
