# strategy_339_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_339_REVERSEPL")

class Strategy339Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [339 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
