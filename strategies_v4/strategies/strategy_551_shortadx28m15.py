# strategy_551_shortadx28m15.py — стратегия: разрешение по ADX (m15, length=28) через универсальный решатель
...
log = logging.getLogger("strategy_551_shortadx28m15")
...
class Strategy551Shortadx28m15:
