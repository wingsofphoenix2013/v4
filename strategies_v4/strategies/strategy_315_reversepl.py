# strategy_315_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_315_REVERSEPL")

class Strategy315Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [315 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
