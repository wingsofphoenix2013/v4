...
log = logging.getLogger("strategy_732_short")

class Strategy732Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[732_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_732_short")
