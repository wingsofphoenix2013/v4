# strategy_411_shortm5m15h1.py — зеркальная стратегия (шорт; laboratory_v4 TF: m5m15h1; таймаут ожидания 90с; INFO-логи; запись ignore в signal_log_queue)
...
# 🔸 Логгер стратегии
log = logging.getLogger("strategy_411_shortm5m15h1")

# 🔸 Класс стратегии
class Strategy411Shortm5m15h1:
