...
log = logging.getLogger("strategy_562_long")

class Strategy562Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[562_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_562_long")
