...
log = logging.getLogger("strategy_550_short")

class Strategy550Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            for tf in tfs:
                ...
                # 2. Проверка winrate
                conf_key = f"confidence:{strategy_id}:short:{tf}:pattern:{pattern_id}"
            ...
            log.exception("❌ Ошибка в strategy_550_short")
