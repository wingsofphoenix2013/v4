# strategy_210_universal.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_210_universal")

# 🔸 Класс стратегии
class Strategy210Universal:
