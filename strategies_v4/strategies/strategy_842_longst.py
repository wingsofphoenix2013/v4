...
log = logging.getLogger("strategy_842_longst")

class Strategy842Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[842_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_842_longst")
