# strategy_547_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_547_REVERSEPL")

class Strategy547Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [547 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
