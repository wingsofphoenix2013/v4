...
log = logging.getLogger("strategy_741_short")

class Strategy741Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[741_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_741_short")
