...
log = logging.getLogger("STRATEGY_368_LEVEL2")

class Strategy368Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[368] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[368:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_368_level2")
