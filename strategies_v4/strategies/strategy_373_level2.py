...
log = logging.getLogger("STRATEGY_373_LEVEL2")

class Strategy373Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[373] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[373:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.debug(f"[373:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_373_level2")
