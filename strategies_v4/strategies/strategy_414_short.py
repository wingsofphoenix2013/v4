# strategy_414_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_414_short")

class Strategy414Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[414_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_414_short")
