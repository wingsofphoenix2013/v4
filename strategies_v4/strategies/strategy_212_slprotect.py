# strategy_212_slprotect.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_212_SLPROTECT")

class Strategy212Slprotect:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [212 SLPROTECT] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
