# strategy_227_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_227_REVERSEPL")

class Strategy227Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [227 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
