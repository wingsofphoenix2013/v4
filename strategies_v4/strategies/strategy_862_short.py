...
log = logging.getLogger("strategy_862_short")

class Strategy862Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[862_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_862_short")
