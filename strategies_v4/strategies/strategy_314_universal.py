# strategy_314_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_314_universal")

class Strategy314Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[314] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_314_level1")
