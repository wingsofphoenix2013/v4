# strategy_307_reversepl0.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_307_REVERSEPL0")

class Strategy307Reversepl0:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [307 REVERSEPL0] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
