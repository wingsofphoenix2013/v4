...
log = logging.getLogger("strategy_571_longst")

class Strategy571Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[571_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_571_longst")
