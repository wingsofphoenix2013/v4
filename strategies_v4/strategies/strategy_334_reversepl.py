# strategy_334_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_334_REVERSEPL")

class Strategy334Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [334 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
