# strategy_258_reverse.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_258_REVERSE")

class Strategy258Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [258 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
