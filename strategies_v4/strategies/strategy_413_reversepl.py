# strategy_413_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_413_REVERSEPL")

class Strategy413Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [413 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
