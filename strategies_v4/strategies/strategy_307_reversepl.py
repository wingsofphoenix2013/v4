# strategy_307_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_307_REVERSEPL")

class Strategy307Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [307 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
                      f"adx={adx}, rsi={rsi}, macd={macd}, signal={macd_signal}")

            if None in (adx, rsi, macd, macd_signal):
                return ("ignore", "нет значений ADX, RSI или MACD")
