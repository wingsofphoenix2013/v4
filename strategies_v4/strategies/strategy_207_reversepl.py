# strategy_207_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_207_REVERSEPL")

class Strategy207Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [207 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
