# strategy_823_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_823_universal")

class Strategy823Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[823] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_823_level1")
