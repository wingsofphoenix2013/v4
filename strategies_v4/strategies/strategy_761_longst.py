...
log = logging.getLogger("strategy_761_longst")

class Strategy761Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[761_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_761_longst")
