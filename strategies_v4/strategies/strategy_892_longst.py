...
log = logging.getLogger("strategy_892_longst")

class Strategy892Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[892_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_892_longst")
