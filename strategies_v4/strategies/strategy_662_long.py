...
log = logging.getLogger("strategy_662_long")

class Strategy662Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[662_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_662_long")
