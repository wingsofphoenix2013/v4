...
log = logging.getLogger("strategy_760_universalst")

class Strategy760Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Ошибка в strategy_760_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [760] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [760] Ошибка при отправке сигнала: {e}")