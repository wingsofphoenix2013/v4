# strategy_427_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_427_short")

class Strategy427Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[427_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_427_short")
