# strategy_650_reverse.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_650_reverse")

# 🔸 Класс стратегии
class Strategy650Reverse:
