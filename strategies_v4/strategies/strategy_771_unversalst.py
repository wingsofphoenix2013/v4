...
log = logging.getLogger("strategy_771_universalst")

class Strategy771Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Ошибка в strategy_771_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [771] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [771] Ошибка при отправке сигнала: {e}")