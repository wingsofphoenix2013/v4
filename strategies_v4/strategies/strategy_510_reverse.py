# strategy_510_reverse.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_510_reverse")

# 🔸 Класс стратегии
class Strategy510Reverse:
