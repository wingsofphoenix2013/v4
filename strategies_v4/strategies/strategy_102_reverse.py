# strategy_102_reverse.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_102_reverse")

# 🔸 Класс стратегии
class Strategy102Reverse:
