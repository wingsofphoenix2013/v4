...
log = logging.getLogger("strategy_811_longst")

class Strategy811Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[811_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_811_longst")
