# strategy_341_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_341_REVERSEPL")

class Strategy341Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [341 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}")
