# strategy_751_longadx28m15.py — стратегия: разрешение по ADX (m15, length=28) через универсальный решатель
...
log = logging.getLogger("strategy_751_longadx28m15")
