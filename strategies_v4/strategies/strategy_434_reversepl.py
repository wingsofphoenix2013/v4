# strategy_434_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_434_REVERSEPL")

class Strategy434Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [434 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
