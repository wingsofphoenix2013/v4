# strategy_701_shortemapath1.py — стратегия: разрешение по EMA-паттернам (только h1, short)
...
log = logging.getLogger("strategy_701_shortemapath1")
...
class Strategy701Shortemapath1:
