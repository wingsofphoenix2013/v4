...
log = logging.getLogger("strategy_741_universalst")

class Strategy741Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Ошибка в strategy_741_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [741] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [741] Ошибка при отправке сигнала: {e}")