# strategy_451_flat.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_451_FLAT")

class Strategy451Flat:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [451 FLAT] symbol={symbol}, direction={direction}, tf={tf}, current_price={current_price}, ema21={ema21}")
