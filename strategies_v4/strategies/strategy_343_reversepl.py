# strategy_343_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_343_REVERSEPL")

class Strategy343Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [343 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
