# strategy_336_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_336_REVERSEPL")

class Strategy336Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [336 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
