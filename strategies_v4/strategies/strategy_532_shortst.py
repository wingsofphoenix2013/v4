...
log = logging.getLogger("strategy_532_shortst")

class Strategy532Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[532_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_532_shortst")
