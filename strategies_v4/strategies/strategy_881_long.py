...
log = logging.getLogger("strategy_881_long")

class Strategy881Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[881_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_881_long")
