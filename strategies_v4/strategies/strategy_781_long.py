...
log = logging.getLogger("strategy_781_long")

class Strategy781Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[781_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_781_long")
