# strategy_442_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_442_REVERSEPL")

class Strategy442Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [442 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
            ...
            if direction == "long":
                if ema21 > ema50 and price > ema21 and rsi > 50 and plus_di > minus_di:
                    return True
                return ("ignore", f"фильтр long не пройден: ema21={ema21}, ema50={ema50}, "
                                  f"price={price}, rsi={rsi}, DI+={plus_di}, DI-={minus_di}")

            elif direction == "short":
                if ema21 < ema50 and price < ema21 and rsi < 50 and minus_di > plus_di:
                    return True
