# strategy_602_mwema50uni.py — 🔸 Универсальная стратегия (MW×EMA50 квартет): live MW-триплет + posfeat m5 EMA50-status, ORACLE пороги 0.15% / 0.55
...
log = logging.getLogger("strategy_602_mwema50uni")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy602Mwema50uni:
