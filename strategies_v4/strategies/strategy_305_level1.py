...
log = logging.getLogger("STRATEGY_305_LEVEL1")

class Strategy305Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[305] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[305:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_305_level1")
