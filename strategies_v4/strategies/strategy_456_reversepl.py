# strategy_456_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_456_REVERSEPL")

class Strategy456Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [456 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
