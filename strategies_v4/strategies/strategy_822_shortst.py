...
log = logging.getLogger("strategy_822_shortst")

class Strategy822Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[822_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_822_shortst")
