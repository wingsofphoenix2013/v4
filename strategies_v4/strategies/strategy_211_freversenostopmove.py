# strategy_211_freversenostopmove.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_211_FREVERSENOSTOPMOVE")

class Strategy211Freversenostopmove:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [211 FREVERSENOSTOPMOVE] symbol={symbol}, direction={direction}, tf={tf}, "
