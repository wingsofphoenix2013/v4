...
log = logging.getLogger("strategy_781_short")

class Strategy781Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[781_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_781_short")
