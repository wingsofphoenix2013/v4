# strategy_423_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_423_long")

class Strategy423Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[423_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_423_long")
