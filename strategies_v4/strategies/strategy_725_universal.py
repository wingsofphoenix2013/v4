# strategy_725_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_725_universal")

class Strategy725Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[725] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_725_level1")
