# strategy_325_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_325_REVERSEPL")

class Strategy325Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [325 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
