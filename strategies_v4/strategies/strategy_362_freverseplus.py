# strategy_362_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_362_FREVERSEPLUS")

class Strategy362Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [312 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
