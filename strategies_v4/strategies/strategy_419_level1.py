...
log = logging.getLogger("STRATEGY_419_LEVEL1")

class Strategy419Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[419] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[419:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_419_level1")
