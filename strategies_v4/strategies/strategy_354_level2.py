...
log = logging.getLogger("STRATEGY_354_LEVEL2")

class Strategy354Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[354] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[354:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_354_level2")
