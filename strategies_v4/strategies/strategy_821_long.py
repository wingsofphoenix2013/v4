...
class Strategy821Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[821_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_821_universal_longonly")
