...
log = logging.getLogger("strategy_821_long")

class Strategy821Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[821_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_821_long")
