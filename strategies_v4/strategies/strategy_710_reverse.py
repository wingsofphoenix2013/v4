# strategy_710_reverse.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_710_reverse")

# 🔸 Класс стратегии
class Strategy710Reverse:
