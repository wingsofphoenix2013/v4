# strategy_551_longmfi14m15.py — стратегия: разрешение по MFI (m15, length=14) через универсальный решатель
...
log = logging.getLogger("strategy_551_longmfi14m15")
