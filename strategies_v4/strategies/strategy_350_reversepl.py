# strategy_350_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_350_REVERSEPL")

class Strategy350Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [350 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
