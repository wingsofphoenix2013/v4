...
log = logging.getLogger("STRATEGY_269_LEVEL1")

class Strategy269Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[269] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[269:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_269_level1")
