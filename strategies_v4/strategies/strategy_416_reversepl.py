# strategy_416_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_416_REVERSEPL")

class Strategy416Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [416 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
