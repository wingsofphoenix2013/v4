# strategy_621_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_621_short")

class Strategy621Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[621_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_621_universal_shortonly")
