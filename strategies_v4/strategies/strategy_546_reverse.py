# strategy_546_reverse.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_546_REVERSE")

class Strategy546Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [546 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, "
