# strategy_414_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_414_REVERSEPL")

class Strategy414Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [414 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
