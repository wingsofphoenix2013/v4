...
log = logging.getLogger("strategy_651_longst")

class Strategy651Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[651_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_651_longst")
