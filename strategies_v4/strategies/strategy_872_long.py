...
log = logging.getLogger("strategy_872_long")

class Strategy872Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[872_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_872_long")
