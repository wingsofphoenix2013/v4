...
log = logging.getLogger("strategy_762_short")

class Strategy762Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[762_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_762_short")
