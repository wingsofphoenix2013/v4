...
log = logging.getLogger("STRATEGY_204_LEVEL1")

class Strategy204Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[204] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[204:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_204_level1")
