...
log = logging.getLogger("strategy_732_longst")

class Strategy732Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[732_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_732_longst")
