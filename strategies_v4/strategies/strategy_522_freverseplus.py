# strategy_522_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_522_FREVERSEPLUS")

class Strategy522Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [522 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
