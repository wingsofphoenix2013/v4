# strategy_701_rsibinlong.py — 🔸 Лонговая стратегия (RSI14 bins): берём posfeat-комбо мастера, сверяем с ORACLE, пороги по направлению
...
log = logging.getLogger("strategy_701_rsibinlong")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy701Rsibinlong:
