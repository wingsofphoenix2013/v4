# strategy_411_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_411_universal")

class Strategy411Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[411] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
