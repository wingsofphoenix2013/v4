# strategy_316_freversenostopmove.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_316_FREVERSENOSTOPMOVE")

class Strategy316Freversenostopmove:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [216 FREVERSENOSTOPMOVE] symbol={symbol}, direction={direction}, tf={tf}, "
