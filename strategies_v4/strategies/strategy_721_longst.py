...
log = logging.getLogger("strategy_721_longst")

class Strategy721Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[721_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_721_longst")
