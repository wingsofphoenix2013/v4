# strategy_263_slprotect.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_263_SLPROTECT")

class Strategy263Slprotect:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [263 SLPROTECT] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
