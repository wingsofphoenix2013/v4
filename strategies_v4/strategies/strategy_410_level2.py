...
log = logging.getLogger("STRATEGY_410_LEVEL2")

class Strategy410Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[410] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[410:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.debug(f"[410:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_410_level2")
