# strategy_420_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_420_short")

class Strategy420Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[420_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_420_short")
