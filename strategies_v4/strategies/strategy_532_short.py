...
log = logging.getLogger("strategy_532_short")

class Strategy532Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[532_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_532_short")
