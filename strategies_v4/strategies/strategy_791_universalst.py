...
log = logging.getLogger("strategy_791_universalst")

class Strategy791Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Ошибка в strategy_791_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [791] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [791] Ошибка при отправке сигнала: {e}")