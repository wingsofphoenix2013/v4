# strategy_524_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_524_long")

class Strategy524Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[524_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_524_universal_longonly")
