# strategy_307_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_307_FREVERSEPLUS")

class Strategy307Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [207 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
