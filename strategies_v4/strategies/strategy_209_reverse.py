# strategy_209_reverse.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_209_REVERSE")

class Strategy209Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [209 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
