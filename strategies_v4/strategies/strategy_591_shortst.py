...
log = logging.getLogger("strategy_591_shortst")

class Strategy591Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[591_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_591_shortst")
