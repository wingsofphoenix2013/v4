...
log = logging.getLogger("STRATEGY_266_LEVEL1")

class Strategy266Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[266] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[266:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_266_level1")
