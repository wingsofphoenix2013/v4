# strategy_450_reverse.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_450_reverse")

# 🔸 Класс стратегии
class Strategy450Reverse:
