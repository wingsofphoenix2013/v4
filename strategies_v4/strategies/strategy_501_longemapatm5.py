# strategy_501_longemapatm5.py — стратегия: разрешение по EMA-паттернам (только m5)
...
log = logging.getLogger("strategy_501_longemapatm5")
