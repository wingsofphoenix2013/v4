# strategy_100_realbinance.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_100_realbinance")

class Strategy100Realbinance:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[100] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_100_realbinance")
