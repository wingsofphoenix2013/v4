# strategy_520_level1.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_520_LEVEL1")

class Strategy520Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[520] symbol={symbol}, tf={tf}, direction={direction}, price={price}, rsi={rsi}")
            ...
            log.exception("❌ Ошибка в strategy_520_level1")
