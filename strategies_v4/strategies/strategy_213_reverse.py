# strategy_213_reverse.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_213_REVERSE")

class Strategy213Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [213 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
