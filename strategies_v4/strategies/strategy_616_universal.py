# strategy_616_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_616_universal")

class Strategy616Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[616] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_616_level1")
