...
log = logging.getLogger("strategy_621_shortst")

class Strategy621Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[621_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_621_shortst")
