# strategy_402_reverse.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_402_REVERSE")

class Strategy402Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [402 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, current_price={current_price}, ema21={ema21}, ema50={ema50}")
