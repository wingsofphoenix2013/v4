# strategy_263_reverse.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_263_REVERSE")

class Strategy263Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [263 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
