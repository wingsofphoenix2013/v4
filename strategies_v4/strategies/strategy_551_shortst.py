...
log = logging.getLogger("strategy_551_shortst")

class Strategy551Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[551_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_551_shortst")
