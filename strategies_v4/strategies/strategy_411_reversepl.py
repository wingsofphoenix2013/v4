# strategy_411_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_411_REVERSEPL")

class Strategy411Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [411 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
