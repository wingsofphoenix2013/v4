# strategy_221_flat.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_221_FLAT")

class Strategy221Flat:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [221 FLAT] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
