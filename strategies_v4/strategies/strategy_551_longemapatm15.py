# strategy_551_longemapatm15.py — стратегия: разрешение по EMA-паттернам (только m15)
...
log = logging.getLogger("strategy_551_longemapatm15")
...
class Strategy551Longemapatm15:
