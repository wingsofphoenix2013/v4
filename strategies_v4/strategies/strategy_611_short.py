# strategy_611_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_611_short")

class Strategy611Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[611_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_611_universal_shortonly")
