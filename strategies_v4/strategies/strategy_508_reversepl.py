# strategy_508_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_508_REVERSEPL")

class Strategy508Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [508 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
