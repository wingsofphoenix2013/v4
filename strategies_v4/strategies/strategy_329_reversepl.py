# strategy_329_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_329_REVERSEPL")

class Strategy329Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [329 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, mfi={mfi}")
