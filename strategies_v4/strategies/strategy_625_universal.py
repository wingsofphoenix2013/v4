# strategy_625_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_625_universal")

class Strategy625Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[625] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_625_level1")
