# strategy_522_level1.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_522_LEVEL1")

class Strategy522Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[522] symbol={symbol}, tf={tf}, direction={direction}, price={price}, rsi={rsi}")
