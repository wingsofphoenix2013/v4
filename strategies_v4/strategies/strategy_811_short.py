# strategy_811_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_811_short")

class Strategy811Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[811_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_811_universal_shortonly")
