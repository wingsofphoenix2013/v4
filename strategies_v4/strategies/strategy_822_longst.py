...
log = logging.getLogger("strategy_822_longst")

class Strategy822Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[822_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_822_longst")
