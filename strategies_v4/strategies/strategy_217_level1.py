...
log = logging.getLogger("STRATEGY_217_LEVEL1")

class Strategy217Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[217] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[217:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_217_level1")
