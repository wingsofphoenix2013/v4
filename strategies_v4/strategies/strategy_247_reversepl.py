# strategy_247_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_247_REVERSEPL")

class Strategy247Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [247 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
