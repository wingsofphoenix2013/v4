...
log = logging.getLogger("strategy_852_longst")

class Strategy852Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[852_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_852_longst")
