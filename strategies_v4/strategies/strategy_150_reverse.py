# strategy_150_reverse.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_150_reverse")

# 🔸 Класс стратегии
class Strategy150Reverse:
