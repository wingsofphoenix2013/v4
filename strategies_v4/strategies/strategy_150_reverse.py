# strategy_250_reverse.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_250_reverse")

# 🔸 Класс стратегии
class Strategy250Reverse:
