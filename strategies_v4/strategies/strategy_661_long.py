...
log = logging.getLogger("strategy_661_long")

class Strategy661Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[661_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_661_long")
