# strategy_306_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_306_REVERSEPL")

class Strategy306Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [306 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
