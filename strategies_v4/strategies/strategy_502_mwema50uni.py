# strategy_502_mwema50uni.py — 🔸 Универсальная стратегия (MW×EMA50 квартет): live MW-триплет + posfeat m5 EMA50-status, ORACLE пороги 0.15% / 0.55
...
log = logging.getLogger("strategy_502_mwema50uni")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy502Mwema50uni:
