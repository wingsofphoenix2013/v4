# strategy_602_mwema9uni.py — 🔸 Универсальная стратегия (MW×EMA9 квартет): live MW-триплет + posfeat m5 EMA9-status, ORACLE пороги 0.15% / 0.55
...
log = logging.getLogger("strategy_602_mwema9uni")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy602Mwema9uni:
