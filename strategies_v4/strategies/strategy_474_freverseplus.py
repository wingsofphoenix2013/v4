# strategy_474_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_474_FREVERSEPLUS")

class Strategy474Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [424 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
