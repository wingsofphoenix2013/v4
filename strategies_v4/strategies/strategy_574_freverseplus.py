# strategy_574_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_574_FREVERSEPLUS")

class Strategy574Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [524 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
