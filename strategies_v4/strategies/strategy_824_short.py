# strategy_824_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_824_short")

class Strategy824Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[824_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_824_universal_shortonly")
