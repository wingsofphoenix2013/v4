# strategy_541_reverse.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_541_REVERSE")

class Strategy541Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [541 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}")
