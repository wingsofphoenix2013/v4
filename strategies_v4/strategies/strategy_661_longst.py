...
log = logging.getLogger("strategy_661_longst")

class Strategy661Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[661_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_661_longst")
