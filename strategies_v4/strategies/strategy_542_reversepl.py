# strategy_542_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_542_REVERSEPL")

class Strategy542Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [542 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
