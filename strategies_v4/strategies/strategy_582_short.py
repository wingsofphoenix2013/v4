...
log = logging.getLogger("strategy_582_short")

class Strategy582Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[582_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_582_short")
