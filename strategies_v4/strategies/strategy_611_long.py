# strategy_611_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_611_long")

class Strategy611Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[611_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_611_universal_longonly")
