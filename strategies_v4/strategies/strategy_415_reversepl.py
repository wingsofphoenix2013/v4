# strategy_415_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_415_REVERSEPL")

class Strategy415Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [415 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
