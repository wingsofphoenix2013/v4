# strategy_114_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_114_long")

class Strategy114Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[114_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_114_long")
