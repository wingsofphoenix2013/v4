# strategy_223_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_223_short")

class Strategy223Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[223_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_223_short")
