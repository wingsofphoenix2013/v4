# strategy_552_mwadxuni.py — 🔸 Универсальная стратегия (MW×ADX квартет): live MW-триплет + posfeat m5 ADX-bin, ORACLE пороги 0.15% / 0.55
...
log = logging.getLogger("strategy_552_mwadxuni")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy552Mwadxuni:
