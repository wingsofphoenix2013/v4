# strategy_722_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_722_universal")

class Strategy722Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[722] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_722_level1")
