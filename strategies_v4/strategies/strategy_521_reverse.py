# strategy_521_reverse.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_521_REVERSE")

class Strategy521Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [521 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}")
