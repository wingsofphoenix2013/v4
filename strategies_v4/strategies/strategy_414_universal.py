# strategy_414_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_414_universal")

class Strategy414Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[414] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_414_level1")
