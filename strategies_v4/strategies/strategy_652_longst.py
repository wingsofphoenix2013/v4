...
log = logging.getLogger("strategy_652_longst")

class Strategy652Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[652_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_652_longst")
