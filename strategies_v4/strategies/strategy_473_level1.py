...
log = logging.getLogger("STRATEGY_473_LEVEL1")

class Strategy473Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[473] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[473:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.debug(f"[473:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_473_level1")
