...
log = logging.getLogger("strategy_532_long")

class Strategy532Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[532_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_532_long")
