# strategy_221_slprotect.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_221_SLPROTECT")

class Strategy221Slprotect:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [221 SLPROTECT] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
