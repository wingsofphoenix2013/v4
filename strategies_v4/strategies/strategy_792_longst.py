...
log = logging.getLogger("strategy_792_longst")

class Strategy792Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[792_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_792_longst")
