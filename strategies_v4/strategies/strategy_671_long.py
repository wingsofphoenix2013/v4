...
log = logging.getLogger("strategy_671_long")

class Strategy671Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[671_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_671_long")
