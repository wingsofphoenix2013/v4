# strategy_122_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_122_universal")

class Strategy122Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[122] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_122_level1")
