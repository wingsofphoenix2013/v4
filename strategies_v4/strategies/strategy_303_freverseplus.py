# strategy_303_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_303_FREVERSEPLUS")

class Strategy303Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [303 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
