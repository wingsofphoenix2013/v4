# strategy_510_level1.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_510_LEVEL1")

class Strategy510Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[510] symbol={symbol}, tf={tf}, direction={direction}, price={price}, rsi={rsi}")
            ...
            log.exception("❌ Ошибка в strategy_510_level1")
