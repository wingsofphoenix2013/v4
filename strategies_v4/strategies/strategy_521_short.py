# strategy_521_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_521_short")

class Strategy521Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[521_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_521_universal_shortonly")
