# strategy_116_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_116_universal")

class Strategy116Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[116] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_116_level1")
