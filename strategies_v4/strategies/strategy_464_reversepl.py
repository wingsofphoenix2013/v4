# strategy_464_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_464_REVERSEPL")

class Strategy464Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [464 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
            ...
            if direction == "long":
                ...
                if ema21 > ema50 and price > ema21 and rsi <= 65 and dmi_gap >= 5:
                    return True
                ...
                if ema21 < ema50 and price < ema21 and rsi >= 35 and dmi_gap >= 5:
                    return True
