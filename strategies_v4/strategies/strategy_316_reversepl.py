# strategy_316_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_316_REVERSEPL")

class Strategy316Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [316 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
