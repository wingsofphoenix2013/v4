# strategy_112_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_112_long")

class Strategy112Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            indicators = await load_indicators(symbol, [
                "bb20_2_0_center", "bb20_2_0_lower"
            ], tf)

            bb_center = indicators.get("bb20_2_0_center")
            bb_lower = indicators.get("bb20_2_0_lower")

            log.debug(f"[112_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
                      f"bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_112_long")
