# strategy_370_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_370_FREVERSEPLUS")

class Strategy370Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [320 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
