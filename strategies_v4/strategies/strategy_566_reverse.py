# strategy_566_reverse.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_566_REVERSE")

class Strategy566Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [566 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, "
