# strategy_526_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_526_REVERSEPL")

class Strategy526Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [526 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
