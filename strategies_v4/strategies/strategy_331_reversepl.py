# strategy_331_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_331_REVERSEPL")

class Strategy331Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [331 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
