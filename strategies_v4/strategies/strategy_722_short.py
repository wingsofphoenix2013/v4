# strategy_722_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_722_short")

class Strategy722Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[722_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_722_universal_shortonly")
