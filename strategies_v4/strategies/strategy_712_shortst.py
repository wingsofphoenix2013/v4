...
log = logging.getLogger("strategy_712_shortst")

class Strategy712Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[712_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_712_shortst")
