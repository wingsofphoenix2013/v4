# strategy_525_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_525_short")

class Strategy525Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[525_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_525_universal_shortonly")
