...
log = logging.getLogger("strategy_631_longst")

class Strategy631Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[631_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_631_longst")
