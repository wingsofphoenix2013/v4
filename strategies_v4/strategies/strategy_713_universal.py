# strategy_713_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_713_universal")

class Strategy713Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[713] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_713_level1")
