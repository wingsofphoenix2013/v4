...
log = logging.getLogger("strategy_711_universalst")

class Strategy711Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Ошибка в strategy_711_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [711] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [711] Ошибка при отправке сигнала: {e}")