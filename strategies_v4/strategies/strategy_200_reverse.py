# strategy_200_reverse.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_200_reverse")

# 🔸 Класс стратегии
class Strategy200Reverse:
