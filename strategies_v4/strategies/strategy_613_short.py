# strategy_613_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_613_short")

class Strategy613Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[613_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_613_universal_shortonly")
