...
log = logging.getLogger("strategy_632_long")

class Strategy632Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[632_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_632_long")
