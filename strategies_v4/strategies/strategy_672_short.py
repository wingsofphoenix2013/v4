...
log = logging.getLogger("strategy_672_short")

class Strategy672Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[672_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_672_short")
