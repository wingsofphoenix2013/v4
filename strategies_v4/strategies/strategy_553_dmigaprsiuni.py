# strategy_553_dmigaprsiuni.py — 🔸 Универсальная стратегия (DMI-gap-bin + RSI14-bin): два posfeat-триплета подряд, ORACLE пороги 0.2% / 0.55
...
log = logging.getLogger("strategy_553_dmigaprsiuni")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy553Dmigaprsiuni:
