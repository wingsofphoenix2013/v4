# strategy_823_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_823_short")

class Strategy823Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[823_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_823_universal_shortonly")
