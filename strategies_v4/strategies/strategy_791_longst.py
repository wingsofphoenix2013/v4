...
log = logging.getLogger("strategy_791_longst")

class Strategy791Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[791_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_791_longst")
