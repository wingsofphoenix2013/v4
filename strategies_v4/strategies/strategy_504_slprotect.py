# strategy_504_slprotect.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_504_SLPROTECT")

class Strategy504Slprotect:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [504 SLPROTECT] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}")
