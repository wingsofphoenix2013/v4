# strategy_326_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_326_universal")

class Strategy326Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[326] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_326_level1")
