# strategy_503_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_503_FREVERSEPLUS")

class Strategy503Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [503 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
