...
log = logging.getLogger("STRATEGY_272_LEVEL1")

class Strategy272Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[272] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[272:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.debug(f"[272:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_272_level1")
