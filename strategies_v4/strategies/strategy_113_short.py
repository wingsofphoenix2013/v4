# strategy_113_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_113_short")

class Strategy113Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[113_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_113_short")
