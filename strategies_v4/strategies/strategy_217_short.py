# strategy_217_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_217_short")

class Strategy217Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[217_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_217_short")
