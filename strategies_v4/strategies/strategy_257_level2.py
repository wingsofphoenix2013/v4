...
log = logging.getLogger("STRATEGY_257_LEVEL2")

class Strategy257Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[257] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[257:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_257_level2")
