...
log = logging.getLogger("strategy_850_longst")

class Strategy850Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            # Читаем pattern_id из Redis по m5 и m15
            pattern_ids = {}
            for tf in ("m5", "m15"):
            ...
            # Проверяем winrate по обеим таблицам
            for tf in ("m5", "m15"):
            ...
            log.exception("❌ Ошибка в strategy_850_longst")
