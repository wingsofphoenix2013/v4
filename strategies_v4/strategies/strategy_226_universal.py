# strategy_226_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_226_universal")

class Strategy226Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[226] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_226_level1")
