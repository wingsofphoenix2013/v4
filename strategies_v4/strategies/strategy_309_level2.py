...
log = logging.getLogger("STRATEGY_309_LEVEL2")

class Strategy309Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[309] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[309:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_309_level2")
