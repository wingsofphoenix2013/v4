# strategy_431_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_431_REVERSEPL")

class Strategy431Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [431 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
