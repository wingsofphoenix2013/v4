# strategy_412_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_412_universal")

class Strategy412Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[412] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
