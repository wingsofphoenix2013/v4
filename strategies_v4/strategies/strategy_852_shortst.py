...
log = logging.getLogger("strategy_852_shortst")

class Strategy852Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[852_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_852_shortst")
