# strategy_369_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_369_FREVERSEPLUS")

class Strategy369Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [319 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
