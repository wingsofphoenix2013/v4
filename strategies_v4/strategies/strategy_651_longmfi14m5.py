# strategy_651_longmfi14m5.py — стратегия: разрешение по MFI (m5, length=14) через универсальный решатель
...
log = logging.getLogger("strategy_651_longmfi14m5")
