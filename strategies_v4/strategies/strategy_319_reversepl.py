# strategy_319_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_319_REVERSEPL")

class Strategy319Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [319 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
