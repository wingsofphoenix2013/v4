# strategy_703_bbdmigapuni.py — 🔸 Универсальная стратегия (BB-bin + DMI-gap-bin): два posfeat-триплета подряд, ORACLE пороги 0.2% / 0.55
...
log = logging.getLogger("strategy_703_bbdmigapuni")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy703Bbdmigapuni:
