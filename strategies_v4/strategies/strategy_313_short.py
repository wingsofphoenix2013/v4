# strategy_313_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_313_short")

class Strategy313Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[313_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_313_short")
