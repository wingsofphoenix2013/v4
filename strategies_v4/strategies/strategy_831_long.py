...
log = logging.getLogger("strategy_831_long")

class Strategy831Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[831_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_831_long")
