# strategy_560_level1.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_560_LEVEL1")

class Strategy560Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[560] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_560_level1")
