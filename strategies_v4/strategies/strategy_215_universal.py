# strategy_215_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_215_universal")

class Strategy215Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[215] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_215_level1")
