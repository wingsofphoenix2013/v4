...
log = logging.getLogger("strategy_771_shortst")

class Strategy771Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[771_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_771_shortst")
