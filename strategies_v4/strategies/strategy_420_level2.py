...
log = logging.getLogger("STRATEGY_420_LEVEL2")

class Strategy420Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[420] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[420:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_420_level2")
