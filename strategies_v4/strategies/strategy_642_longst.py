...
log = logging.getLogger("strategy_642_longst")

class Strategy642Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[642_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_642_longst")
