...
log = logging.getLogger("strategy_661_shortst")

class Strategy661Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[661_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_661_shortst")
