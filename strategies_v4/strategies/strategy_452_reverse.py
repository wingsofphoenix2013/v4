# strategy_452_reverse.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_452_REVERSE")

class Strategy452Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [452 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, current_price={current_price}, ema21={ema21}, ema50={ema50}")
