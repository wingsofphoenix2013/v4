...
log = logging.getLogger("strategy_731_shortst")

class Strategy731Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[731_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_731_shortst")
