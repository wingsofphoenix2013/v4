# strategy_623_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_623_short")

class Strategy623Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[623_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_623_universal_shortonly")
