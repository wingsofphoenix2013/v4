# strategy_438_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_438_REVERSEPL")

class Strategy438Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [438 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
            ...
            if direction == "long":
                if price > ema21 and 50 <= rsi <= 70 and plus_di > minus_di:
                    return True
                return ("ignore", f"фильтр long не пройден: price={price}, ema21={ema21}, rsi={rsi}, DI+={plus_di}, DI-={minus_di}")

            elif direction == "short":
                if price < ema21 and 30 <= rsi <= 50 and minus_di > plus_di:
                    return True
