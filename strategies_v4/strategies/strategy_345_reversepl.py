# strategy_345_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_345_REVERSEPL")

class Strategy345Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [345 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
