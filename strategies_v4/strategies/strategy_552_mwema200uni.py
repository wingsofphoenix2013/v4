# strategy_552_mwema200uni.py — 🔸 Универсальная стратегия (MW×EMA200 квартет): live MW-триплет + posfeat m5 EMA200-status, ORACLE пороги 0.15% / 0.55
...
log = logging.getLogger("strategy_552_mwema200uni")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy552Mwema200uni:
