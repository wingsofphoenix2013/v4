...
log = logging.getLogger("strategy_631_short")

class Strategy631Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[631_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_631_short")
