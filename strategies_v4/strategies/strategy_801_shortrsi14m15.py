# strategy_801_shortrsi14m15.py — стратегия: разрешение по RSI (m15, length=14) через универсальный решатель
...
log = logging.getLogger("strategy_801_shortrsi14m15")
...
class Strategy801Shortrsi14m15:
