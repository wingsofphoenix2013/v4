# strategy_530_level1.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_530_LEVEL1")

class Strategy530Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[530] symbol={symbol}, tf={tf}, direction={direction}, price={price}, mfi={mfi}")
            ...
            log.exception("❌ Ошибка в strategy_530_level1")
