...
log = logging.getLogger("strategy_781_longst")

class Strategy781Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[781_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_781_longst")
