...
log = logging.getLogger("strategy_782_short")

class Strategy782Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[782_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_782_short")
