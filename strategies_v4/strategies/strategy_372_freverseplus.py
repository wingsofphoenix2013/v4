# strategy_372_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_372_FREVERSEPLUS")

class Strategy372Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [322 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
