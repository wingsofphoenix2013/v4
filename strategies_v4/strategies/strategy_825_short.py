# strategy_825_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_825_short")

class Strategy825Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[825_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_825_universal_shortonly")
