# strategy_208_flat.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_208_FLAT")

class Strategy208Flat:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [208 FLAT] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
