...
log = logging.getLogger("strategy_541_longst")

class Strategy541Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[541_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_541_longst")
