...
log = logging.getLogger("strategy_751_shortst")

class Strategy751Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[751_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_751_shortst")
