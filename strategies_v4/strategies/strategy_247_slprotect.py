# strategy_247_slprotect.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_247_SLPROTECT")

class Strategy247Slprotect:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [247 SLPROTECT] symbol={symbol}, direction={direction}, tf={tf}, "
