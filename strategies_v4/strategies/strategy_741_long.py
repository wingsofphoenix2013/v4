...
log = logging.getLogger("strategy_741_long")

class Strategy741Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[741_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_741_long")
