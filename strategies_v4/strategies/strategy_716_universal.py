# strategy_716_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_716_universal")

class Strategy716Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[716] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_716_level1")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.warning(f"⚠️ Ошибка при отправке сигнала: {e}")ё