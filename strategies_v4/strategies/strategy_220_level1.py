...
log = logging.getLogger("STRATEGY_220_LEVEL1")

class Strategy220Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[220] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[220:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_220_level1")
