# strategy_310_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_310_REVERSEPL")

class Strategy310Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [310 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
