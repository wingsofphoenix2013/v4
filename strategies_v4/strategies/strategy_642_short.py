...
log = logging.getLogger("strategy_642_short")

class Strategy642Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[642_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_642_short")
