...
log = logging.getLogger("strategy_891_long")

class Strategy891Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[891_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_891_long")
