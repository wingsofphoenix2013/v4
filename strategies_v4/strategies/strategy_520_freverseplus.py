# strategy_520_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_520_FREVERSEPLUS")

class Strategy520Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [220 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
