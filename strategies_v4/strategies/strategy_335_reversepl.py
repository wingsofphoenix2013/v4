# strategy_335_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_335_REVERSEPL")

class Strategy335Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [335 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
