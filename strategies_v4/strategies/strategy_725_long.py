# strategy_725_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_725_long")

class Strategy725Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[725_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_725_universal_longonly")
