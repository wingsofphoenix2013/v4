...
log = logging.getLogger("STRATEGY_261_LEVEL2")

class Strategy261Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[261] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[261:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.debug(f"[261:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_261_level2")
