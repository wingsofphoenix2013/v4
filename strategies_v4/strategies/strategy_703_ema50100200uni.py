# strategy_703_ema50100200uni.py — 🔸 Универсальная стратегия (EMA50 + EMA100 + EMA200): три posfeat-триплета подряд, ORACLE пороги 0.2% / 0.55
...
log = logging.getLogger("strategy_703_ema50100200uni")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy703Ema50100200uni:
