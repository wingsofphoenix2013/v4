# strategy_826_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_826_short")

class Strategy826Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[826_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_826_universal_shortonly")
