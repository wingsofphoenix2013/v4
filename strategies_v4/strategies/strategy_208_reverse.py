# strategy_208_reverse.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_208_REVERSE")

class Strategy208Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [208 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
