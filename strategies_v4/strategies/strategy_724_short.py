# strategy_724_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_724_short")

class Strategy724Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[724_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_724_universal_shortonly")
