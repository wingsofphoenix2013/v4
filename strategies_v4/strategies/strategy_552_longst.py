...
log = logging.getLogger("strategy_552_longst")

class Strategy552Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[552_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_552_longst")
