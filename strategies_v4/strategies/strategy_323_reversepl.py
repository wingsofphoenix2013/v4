# strategy_323_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_323_REVERSEPL")

class Strategy323Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [323 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
