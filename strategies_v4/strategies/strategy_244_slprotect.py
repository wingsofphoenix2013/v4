# strategy_244_slprotect.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_244_SLPROTECT")

class Strategy244Slprotect:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [244 SLPROTECT] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}, adx={adx}")
