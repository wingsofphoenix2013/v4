# strategy_543_level1.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_543_LEVEL1")

class Strategy543Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[543] symbol={symbol}, tf={tf}, direction={direction}, price={price}, mfi={mfi}")
            ...
            log.exception("❌ Ошибка в strategy_543_level1")
