...
log = logging.getLogger("strategy_752_shortst")

class Strategy752Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[752_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_752_shortst")
