...
log = logging.getLogger("strategy_742_longst")

class Strategy742Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[742_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_742_longst")
