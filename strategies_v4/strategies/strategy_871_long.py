...
log = logging.getLogger("strategy_871_long")

class Strategy871Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[871_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_871_long")
