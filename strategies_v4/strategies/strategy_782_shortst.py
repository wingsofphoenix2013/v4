...
log = logging.getLogger("strategy_782_shortst")

class Strategy782Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[782_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_782_shortst")
