# strategy_501_shortemapatm15.py — стратегия: разрешение по EMA-паттернам (только m15, short)
...
log = logging.getLogger("strategy_501_shortemapatm15")
...
class Strategy501Shortemapatm15:
