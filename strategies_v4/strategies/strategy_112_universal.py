# strategy_112_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_112_universal")

class Strategy112Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[112] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_112_level1")
