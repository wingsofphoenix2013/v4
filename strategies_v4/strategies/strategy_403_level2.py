# strategy_403_level2.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_403_LEVEL2")

class Strategy403Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[403] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.exception("❌ Ошибка в strategy_403_level2")
