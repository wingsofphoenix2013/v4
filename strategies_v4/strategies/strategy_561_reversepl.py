# strategy_561_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_561_REVERSEPL")

class Strategy561Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [561 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}")
