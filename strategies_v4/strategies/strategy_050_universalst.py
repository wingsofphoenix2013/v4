...
log = logging.getLogger("strategy_050_universalst")

class Strategy050Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Необработанная ошибка в strategy_050_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [050] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [050] Ошибка при отправке сигнала: {e}")