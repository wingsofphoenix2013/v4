# strategy_542_reverse.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_542_REVERSE")

class Strategy542Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [542 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
