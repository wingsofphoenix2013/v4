# strategy_506_reverse.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_506_REVERSE")

class Strategy506Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [506 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, "
