...
log = logging.getLogger("STRATEGY_421_LEVEL2")

class Strategy421Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[421] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[421:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_421_level2")
