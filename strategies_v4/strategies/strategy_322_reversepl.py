# strategy_322_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_322_REVERSEPL")

class Strategy322Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [322 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
