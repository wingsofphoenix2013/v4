# strategy_402_mwema100uni.py — 🔸 Универсальная стратегия (MW×EMA100 квартет): live MW-триплет + posfeat m5 EMA100-status, ORACLE пороги 0.15% / 0.55
...
log = logging.getLogger("strategy_402_mwema100uni")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy402Mwema100uni:
