# strategy_352_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_352_REVERSEPL")

class Strategy352Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [352 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
