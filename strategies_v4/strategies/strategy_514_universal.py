# strategy_514_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_514_universal")

class Strategy514Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[514] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_514_level1")
