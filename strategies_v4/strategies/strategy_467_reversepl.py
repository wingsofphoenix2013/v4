# strategy_467_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_467_REVERSEPL")

class Strategy467Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [467 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
            ...
            if direction == "long":
                ...
                if ema21 > ema50 and price > ema21 and 45 <= rsi <= 65 and dmi_gap >= 5:
                    return True
                ...
                if ema21 < ema50 and price < ema21 and 35 <= rsi <= 55 and dmi_gap >= 5:
                    return True
