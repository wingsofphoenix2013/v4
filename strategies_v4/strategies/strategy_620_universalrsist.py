...
log = logging.getLogger("strategy_620_universalrsist")

class Strategy620Universalrsist:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            # 🔹 Проверка по каждому таймфрейму
            for tf in ("m5", "m15"):
            ...
            return True  # оба таймфрейма прошли проверку

        except Exception:
            log.exception("Ошибка в strategy_620_universalrsist")
