# strategy_241_flat.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_241_FLAT")

class Strategy241Flat:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [241 FLAT] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
