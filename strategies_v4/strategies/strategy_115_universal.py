# strategy_115_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_115_universal")

class Strategy115Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[115] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_115_level1")
