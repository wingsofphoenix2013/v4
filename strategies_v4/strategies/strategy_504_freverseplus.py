# strategy_504_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_504_FREVERSEPLUS")

class Strategy504Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [204 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
