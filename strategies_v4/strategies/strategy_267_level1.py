...
log = logging.getLogger("STRATEGY_267_LEVEL1")

class Strategy267Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[267] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[267:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_267_level1")
