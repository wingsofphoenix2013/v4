# strategy_353_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_353_REVERSEPL")

class Strategy353Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [353 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
