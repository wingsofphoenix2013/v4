# strategy_701_shortadx14m5.py — стратегия: разрешение по ADX (m5, length=14) через универсальный решатель
...
log = logging.getLogger("strategy_701_shortadx14m5")
