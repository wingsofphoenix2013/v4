...
log = logging.getLogger("STRATEGY_208_LEVEL1")

class Strategy208Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[208] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[208:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_208_level1")
