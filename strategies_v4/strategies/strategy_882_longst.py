...
log = logging.getLogger("strategy_882_longst")

class Strategy882Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[882_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_882_longst")
