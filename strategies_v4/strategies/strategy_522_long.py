...
log = logging.getLogger("strategy_522_long")

class Strategy522Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[522_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_522_long")
