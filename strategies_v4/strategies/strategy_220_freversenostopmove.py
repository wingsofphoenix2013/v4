# strategy_220_freversenostopmove.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_220_FREVERSENOSTOPMOVE")

class Strategy220Freversenostopmove:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [220 FREVERSENOSTOPMOVE] symbol={symbol}, direction={direction}, tf={tf}, "
