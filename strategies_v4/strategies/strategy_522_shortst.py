...
log = logging.getLogger("strategy_522_shortst")

class Strategy522Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[522_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_522_shortst")
