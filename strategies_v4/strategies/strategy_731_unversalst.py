...
log = logging.getLogger("strategy_731_universalst")

class Strategy731Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Ошибка в strategy_731_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [731] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [731] Ошибка при отправке сигнала: {e}")