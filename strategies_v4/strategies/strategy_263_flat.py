# strategy_263_flat.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_263_FLAT")

class Strategy263Flat:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [263 FLAT] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
