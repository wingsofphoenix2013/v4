# strategy_207_reverse.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_207_REVERSE")

class Strategy207Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [207 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
