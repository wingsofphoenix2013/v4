# strategy_264_slprotect.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_264_SLPROTECT")

class Strategy264Slprotect:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [264 SLPROTECT] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}, adx={adx}")
