...
log = logging.getLogger("strategy_622_shortst")

class Strategy622Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[622_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_622_shortst")
