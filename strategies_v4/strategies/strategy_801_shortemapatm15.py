# strategy_801_shortemapatm15.py — стратегия: разрешение по EMA-паттернам (только m15, short)
...
log = logging.getLogger("strategy_801_shortemapatm15")
...
class Strategy801Shortemapatm15:
