# strategy_425_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_425_universal")

class Strategy425Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[425] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_425_level1")
