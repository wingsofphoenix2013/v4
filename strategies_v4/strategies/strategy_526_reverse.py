# strategy_526_reverse.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_526_REVERSE")

class Strategy526Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [526 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, "
