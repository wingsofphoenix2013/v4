# strategy_303_freversenostopmove.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_303_FREVERSENOSTOPMOVE")

class Strategy303Freversenostopmove:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [203 FREVERSENOSTOPMOVE] symbol={symbol}, direction={direction}, tf={tf}, "
