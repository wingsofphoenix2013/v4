# strategy_515_level1.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_515_LEVEL1")

class Strategy515Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[515] symbol={symbol}, tf={tf}, direction={direction}, price={price}, rsi={rsi}")
