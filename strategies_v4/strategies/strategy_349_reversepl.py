# strategy_349_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_349_REVERSEPL")

class Strategy349Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [349 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, mfi={mfi}")
