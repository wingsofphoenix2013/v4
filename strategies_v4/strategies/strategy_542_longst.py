...
log = logging.getLogger("strategy_542_longst")

class Strategy542Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[542_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_542_longst")
