...
log = logging.getLogger("strategy_552_shortst")

class Strategy552Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[552_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_552_shortst")
