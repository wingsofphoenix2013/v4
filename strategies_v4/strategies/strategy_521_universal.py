...
log = logging.getLogger("strategy_521_universal")

class Strategy521Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[521_BB+SNAPSHOT] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_521_universal")
