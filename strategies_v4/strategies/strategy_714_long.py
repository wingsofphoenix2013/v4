# strategy_714_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_714_long")

class Strategy714Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[714_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_714_universal_longonly")
