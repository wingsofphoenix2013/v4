# strategy_601_longemapath1.py — стратегия: разрешение по EMA-паттернам (только h1)
...
log = logging.getLogger("strategy_601_longemapath1")
