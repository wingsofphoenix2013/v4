# strategy_262_slprotect.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_262_SLPROTECT")

class Strategy262Slprotect:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [262 SLPROTECT] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
