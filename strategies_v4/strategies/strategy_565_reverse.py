# strategy_565_reverse.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_565_REVERSE")

class Strategy565Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [565 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, price={price}, "
