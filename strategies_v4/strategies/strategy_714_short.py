# strategy_714_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_714_short")

class Strategy714Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[714_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_714_universal_shortonly")
