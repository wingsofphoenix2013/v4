# strategy_309_reverse.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_309_reverse")

# 🔸 Класс стратегии
class Strategy309Reverse:
