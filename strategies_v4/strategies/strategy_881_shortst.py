...
log = logging.getLogger("strategy_881_shortst")

class Strategy881Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[881_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_881_shortst")
