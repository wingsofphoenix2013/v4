# strategy_715_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_715_long")

class Strategy715Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[715_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_715_universal_longonly")
