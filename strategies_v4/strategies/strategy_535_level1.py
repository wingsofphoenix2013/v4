# strategy_535_level1.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_535_LEVEL1")

class Strategy535Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[535] symbol={symbol}, tf={tf}, direction={direction}, price={price}, mfi={mfi}")
            ...
            log.exception("❌ Ошибка в strategy_535_level1")
