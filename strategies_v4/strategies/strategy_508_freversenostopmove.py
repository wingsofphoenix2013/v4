# strategy_508_freversenostopmove.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_508_FREVERSENOSTOPMOVE")

class Strategy508Freversenostopmove:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [208 FREVERSENOSTOPMOVE] symbol={symbol}, direction={direction}, tf={tf}, "
