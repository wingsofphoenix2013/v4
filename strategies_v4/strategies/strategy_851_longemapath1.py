# strategy_851_longemapath1.py — стратегия: разрешение по EMA-паттернам (только h1)
...
log = logging.getLogger("strategy_851_longemapath1")
