...
log = logging.getLogger("strategy_772_shortst")

class Strategy772Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[772_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_772_shortst")
