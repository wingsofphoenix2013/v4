...
log = logging.getLogger("strategy_591_short")

class Strategy591Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[591_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_591_short")
