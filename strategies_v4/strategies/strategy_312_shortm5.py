# strategy_312_shortm5.py — зеркальная стратегия (шорт; laboratory_v4 TF: m5; таймаут ожидания 90с; INFO-логи; запись ignore в signal_log_queue)
...
# 🔸 Логгер стратегии
log = logging.getLogger("strategy_312_shortm5")

# 🔸 Класс стратегии
class Strategy312Shortm5:
