...
log = logging.getLogger("strategy_641_universalst")

class Strategy641Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Необработанная ошибка в strategy_641_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [641] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [641] Ошибка при отправке сигнала: {e}")