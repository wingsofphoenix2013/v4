# strategy_567_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_567_REVERSEPL")

class Strategy567Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [567 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
