# strategy_653_ema921uni.py — 🔸 Универсальная стратегия (EMA9 + EMA21): два posfeat-триплета подряд, ORACLE пороги 0.2% / 0.55
...
log = logging.getLogger("strategy_653_ema921uni")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy653Ema921uni:
