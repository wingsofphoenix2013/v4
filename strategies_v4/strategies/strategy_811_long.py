# strategy_811_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_811_long")

class Strategy811Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[811_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_811_universal_longonly")
