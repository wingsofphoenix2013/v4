# strategy_302_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_302_REVERSEPL")

class Strategy302Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [302 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
