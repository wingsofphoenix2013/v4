...
log = logging.getLogger("strategy_571_shortst")

class Strategy571Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[571_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_571_shortst")
