# strategy_523_reverse.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_523_REVERSE")

class Strategy523Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [523 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
