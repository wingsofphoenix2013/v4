# strategy_300_emacross.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_300_EMACROSS")

class Strategy300Emacross:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [300 EMACROSS] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
