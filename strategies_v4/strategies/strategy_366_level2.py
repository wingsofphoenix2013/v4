...
log = logging.getLogger("STRATEGY_366_LEVEL2")

class Strategy366Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[366] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[366:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_366_level2")
