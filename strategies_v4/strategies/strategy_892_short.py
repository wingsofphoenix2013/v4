...
log = logging.getLogger("strategy_892_short")

class Strategy892Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[892_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_892_short")
