# strategy_564_reverse.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_564_REVERSE")

class Strategy564Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [564 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
