...
log = logging.getLogger("strategy_572_shortst")

class Strategy572Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[572_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_572_shortst")
