...
log = logging.getLogger("strategy_832_short")

class Strategy832Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[832_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_832_short")
