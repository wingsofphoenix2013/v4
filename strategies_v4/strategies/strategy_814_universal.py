# strategy_814_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_814_universal")

class Strategy814Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[814] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_814_level1")
