...
log = logging.getLogger("strategy_791_long")

class Strategy791Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[791_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_791_long")
