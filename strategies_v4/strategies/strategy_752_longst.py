...
log = logging.getLogger("strategy_752_longst")

class Strategy752Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[752_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_752_longst")
