# strategy_721_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_721_short")

class Strategy721Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[721_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_721_universal_shortonly")
