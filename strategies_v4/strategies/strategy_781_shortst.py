...
log = logging.getLogger("strategy_781_shortst")

class Strategy781Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[781_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_781_shortst")
