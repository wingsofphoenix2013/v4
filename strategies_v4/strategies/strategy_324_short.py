# strategy_324_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_324_short")

class Strategy324Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[324_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_324_short")
