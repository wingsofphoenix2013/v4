...
log = logging.getLogger("strategy_671_universalst")

class Strategy671Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Необработанная ошибка в strategy_671_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [671] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [671] Ошибка при отправке сигнала: {e}")