# strategy_515_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_515_universal")

class Strategy515Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[515] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_515_level1")
