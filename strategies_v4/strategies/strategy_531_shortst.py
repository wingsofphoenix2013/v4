...
log = logging.getLogger("strategy_531_shortst")

class Strategy531Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[531_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_531_shortst")
