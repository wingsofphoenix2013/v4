# strategy_513_level1.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_513_LEVEL1")

class Strategy513Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[513] symbol={symbol}, tf={tf}, direction={direction}, price={price}, rsi={rsi}")
