# strategy_469_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_469_REVERSEPL")

class Strategy469Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [469 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
            ...
            if direction == "long":
                ...
                if ema21 > ema50 and price > ema21 and 55 <= rsi <= 75 and dmi_gap >= 5:
                    return True
                ...
                if ema21 < ema50 and price < ema21 and 25 <= rsi <= 45 and dmi_gap >= 5:
                    return True
