# strategy_448_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_448_REVERSEPL")

class Strategy448Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [448 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
