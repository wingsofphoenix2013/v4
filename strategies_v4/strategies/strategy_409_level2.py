...
log = logging.getLogger("STRATEGY_409_LEVEL2")

class Strategy409Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[409] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[409:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_409_level2")
