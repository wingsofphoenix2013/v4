# strategy_551_shortemapatm5.py — стратегия: разрешение по EMA-паттернам (только m5, short)
...
log = logging.getLogger("strategy_551_shortemapatm5")
...
class Strategy551Shortemapatm5:
