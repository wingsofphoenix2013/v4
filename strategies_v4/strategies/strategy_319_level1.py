...
log = logging.getLogger("STRATEGY_319_LEVEL1")

class Strategy319Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[319] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[319:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_319_level1")
