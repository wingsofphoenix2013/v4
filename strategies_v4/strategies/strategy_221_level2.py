...
log = logging.getLogger("STRATEGY_221_LEVEL2")

class Strategy221Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[221] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[221:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_221_level2")
