...
log = logging.getLogger("STRATEGY_404_LEVEL2")

class Strategy404Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[404] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[404:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_404_level2")
