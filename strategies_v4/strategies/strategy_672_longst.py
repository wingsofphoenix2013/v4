...
log = logging.getLogger("strategy_672_longst")

class Strategy672Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[672_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_672_longst")
