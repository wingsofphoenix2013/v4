# strategy_417_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_417_long")

class Strategy417Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[417_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_417_long")
