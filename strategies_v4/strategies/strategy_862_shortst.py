...
log = logging.getLogger("strategy_862_shortst")

class Strategy862Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[862_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_862_shortst")
