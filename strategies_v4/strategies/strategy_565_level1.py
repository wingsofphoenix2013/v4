# strategy_565_level1.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_565_LEVEL1")

class Strategy565Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[565] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_565_level1")
