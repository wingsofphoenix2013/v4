# strategy_354_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_354_REVERSEPL")

class Strategy354Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [354 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
