...
log = logging.getLogger("strategy_861_short")

class Strategy861Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[861_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_861_short")
