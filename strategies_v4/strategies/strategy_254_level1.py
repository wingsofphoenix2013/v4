...
log = logging.getLogger("STRATEGY_254_LEVEL1")

class Strategy254Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[254] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[254:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_254_level1")
