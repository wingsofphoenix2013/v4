...
log = logging.getLogger("strategy_541_shortst")

class Strategy541Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[541_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_541_shortst")
