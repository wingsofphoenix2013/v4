# strategy_114_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_114_short")

class Strategy114Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[114_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_114_short")
