# strategy_225_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_225_short")

class Strategy225Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[225_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_225_short")
