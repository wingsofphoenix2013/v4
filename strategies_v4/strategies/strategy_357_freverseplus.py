# strategy_357_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_357_FREVERSEPLUS")

class Strategy357Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [307 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
