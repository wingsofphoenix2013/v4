# strategy_451_ema9uni.py — 🔸 Универсальная стратегия (EMA9 status): берём posfeat-комбо мастера, сверяем с ORACLE, пороги по направлению
...
log = logging.getLogger("strategy_451_ema9uni")

IgnoreResult = Tuple[str, str]  # ("ignore", reason)


# 🔸 Класс стратегии
class Strategy451Ema9uni:
