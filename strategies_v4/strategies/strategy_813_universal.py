# strategy_813_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_813_universal")

class Strategy813Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[813] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_813_level1")
