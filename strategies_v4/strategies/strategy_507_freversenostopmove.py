# strategy_507_freversenostopmove.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_507_FREVERSENOSTOPMOVE")

class Strategy507Freversenostopmove:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [207 FREVERSENOSTOPMOVE] symbol={symbol}, direction={direction}, tf={tf}, "
            ...
            if direction == "long":
                ...
                if 55 <= rsi <= 75 and lr_angle > 0.005 and price <= bb_upper_25 and price >= bb_limit_lower:
                    return True
                ...
                if 25 <= rsi <= 45 and lr_angle < -0.005 and price >= bb_lower_25 and price <= bb_limit_upper:
                    return True
