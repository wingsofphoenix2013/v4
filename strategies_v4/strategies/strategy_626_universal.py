# strategy_626_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_626_universal")

class Strategy626Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[626] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_626_level1")
