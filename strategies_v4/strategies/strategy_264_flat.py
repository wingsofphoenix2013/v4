# strategy_264_flat.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_264_FLAT")

class Strategy264Flat:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [264 FLAT] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}, adx={adx}")
