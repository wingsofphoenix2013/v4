...
log = logging.getLogger("STRATEGY_205_LEVEL1")

class Strategy205Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[205] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[205:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_205_level1")
