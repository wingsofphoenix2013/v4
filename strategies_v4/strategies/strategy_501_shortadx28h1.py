# strategy_501_shortadx28h1.py — стратегия: разрешение по ADX (h1, length=28) через универсальный решатель
...
log = logging.getLogger("strategy_501_shortadx28h1")
