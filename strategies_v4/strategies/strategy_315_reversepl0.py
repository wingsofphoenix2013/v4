# strategy_315_reversepl0.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_315_REVERSEPL0")

class Strategy315Reversepl0:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [315 REVERSEPL0] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
