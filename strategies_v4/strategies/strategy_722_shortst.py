...
log = logging.getLogger("strategy_722_shortst")

class Strategy722Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[722_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_722_shortst")
