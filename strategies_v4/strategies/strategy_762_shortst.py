...
log = logging.getLogger("strategy_762_shortst")

class Strategy762Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[762_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_762_shortst")
