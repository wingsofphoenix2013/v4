# strategy_851_shortrsi14m15.py — стратегия: разрешение по RSI (m15, length=14) через универсальный решатель
...
log = logging.getLogger("strategy_851_shortrsi14m15")
...
class Strategy851Shortrsi14m15:
