# strategy_466_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_466_FREVERSEPLUS")

class Strategy466Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [416 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
