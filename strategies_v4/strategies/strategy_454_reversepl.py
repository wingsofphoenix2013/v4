# strategy_454_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_454_REVERSEPL")

class Strategy454Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [454 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
