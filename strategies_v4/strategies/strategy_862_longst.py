...
log = logging.getLogger("strategy_862_longst")

class Strategy862Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[862_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_862_longst")
