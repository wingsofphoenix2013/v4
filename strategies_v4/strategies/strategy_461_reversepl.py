# strategy_461_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_461_REVERSEPL")

class Strategy461Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [461 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
