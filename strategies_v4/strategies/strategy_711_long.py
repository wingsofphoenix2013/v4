# strategy_711_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_711_long")

class Strategy711Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[711_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_711_universal_longonly")
