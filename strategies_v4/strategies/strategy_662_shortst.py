...
log = logging.getLogger("strategy_662_shortst")

class Strategy662Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[662_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_662_shortst")
