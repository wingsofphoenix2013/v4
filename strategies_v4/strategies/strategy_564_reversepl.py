# strategy_564_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_564_REVERSEPL")

class Strategy564Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [564 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
