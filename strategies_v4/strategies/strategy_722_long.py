...
class Strategy722Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[722_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_722_universal_longonly")
