# strategy_347_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_347_REVERSEPL")

class Strategy347Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [347 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
