...
log = logging.getLogger("strategy_781_universalst")

class Strategy781Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Ошибка в strategy_781_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [781] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [781] Ошибка при отправке сигнала: {e}")