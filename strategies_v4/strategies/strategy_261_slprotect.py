# strategy_261_slprotect.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_261_SLPROTECT")

class Strategy261Slprotect:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [261 SLPROTECT] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
