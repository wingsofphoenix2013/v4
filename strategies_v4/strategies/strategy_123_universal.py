# strategy_123_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_123_universal")

class Strategy123Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[123] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_123_level1")
