...
log = logging.getLogger("strategy_861_universalst")

class Strategy861Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Ошибка в strategy_861_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [861] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [861] Ошибка при отправке сигнала: {e}")