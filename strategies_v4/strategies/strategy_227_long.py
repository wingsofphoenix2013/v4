# strategy_227_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_227_long")

class Strategy227Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[227_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_227_long")
