...
log = logging.getLogger("strategy_691_long")

class Strategy691Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[691_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_691_long")
