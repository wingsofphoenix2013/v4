# strategy_723_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_723_short")

class Strategy723Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[723_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_723_universal_shortonly")
