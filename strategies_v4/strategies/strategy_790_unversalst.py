...
log = logging.getLogger("strategy_790_universalst")

class Strategy790Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Ошибка в strategy_790_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [790] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [790] Ошибка при отправке сигнала: {e}")