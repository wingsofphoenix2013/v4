...
log = logging.getLogger("strategy_521_longst")

class Strategy521Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            # 🔹 1. Получаем snapshot_id по m5 и m15
            snapshots = {}
            ...
            # 🔹 2. Проверка winrate по m5 и m15
            ...
            log.debug(f"[521_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_521_longst")
