# strategy_418_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_418_REVERSEPL")

class Strategy418Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [418 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
