# strategy_213_flat.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_213_FLAT")

class Strategy213Flat:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [213 FLAT] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
