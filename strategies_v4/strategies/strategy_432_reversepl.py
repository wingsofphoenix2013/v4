# strategy_432_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_432_REVERSEPL")

class Strategy432Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [432 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
