...
log = logging.getLogger("strategy_510_long")

class Strategy510Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            conf_key = f"confidence:{strategy_id}:long:{tf}:snapshot:{snapshot_id}"
            ...
            log.exception("❌ Ошибка в strategy_510_long")
