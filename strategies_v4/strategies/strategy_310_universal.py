# strategy_310_universal.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_310_universal")

# 🔸 Класс стратегии
class Strategy310Universal:
