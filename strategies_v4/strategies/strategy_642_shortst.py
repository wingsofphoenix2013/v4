...
log = logging.getLogger("strategy_642_shortst")

class Strategy642Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[642_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_642_shortst")
