...
log = logging.getLogger("strategy_510_shortrsist")

class Strategy510Shortrsist:
    async def validate_signal(self, signal, context):
        ...
        # 🔹 Фильтруем по направлению — только шорт
        if direction != "short":
        ...
        try:
            ...
            log.exception("❌ Ошибка в strategy_510_shortrsist")
