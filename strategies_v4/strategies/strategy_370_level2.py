...
log = logging.getLogger("STRATEGY_370_LEVEL2")

class Strategy370Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[370] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[370:RSITREND] rsi_2={rsi_2}, rsi_1={rsi_1}")
            ...
            log.exception("❌ Ошибка в strategy_370_level2")
