# strategy_724_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_724_universal")

class Strategy724Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[724] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_724_level1")
