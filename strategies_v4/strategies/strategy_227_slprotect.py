# strategy_227_slprotect.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_227_SLPROTECT")

class Strategy227Slprotect:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [227 SLPROTECT] symbol={symbol}, direction={direction}, tf={tf}, "
            ...
            if direction == "long":
                ...
                if rsi < 28 and mfi < 30 and price < bb_limit:
                    return True
                ...
                if rsi > 72 and mfi > 70 and price > bb_limit:
                    return True
