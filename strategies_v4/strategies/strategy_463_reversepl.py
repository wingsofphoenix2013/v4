# strategy_463_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_463_REVERSEPL")

class Strategy463Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [463 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
            ...
            if direction == "long":
                ...
                if ema21 > ema50 and price > ema21 and rsi > 55 and dmi_gap >= 5:
                    return True
                ...
                if ema21 < ema50 and price < ema21 and rsi < 45 and dmi_gap >= 5:
                    return True
