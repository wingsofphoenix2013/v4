# strategy_560_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_560_FREVERSEPLUS")

class Strategy560Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [510 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
