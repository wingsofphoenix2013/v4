# strategy_563_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_563_REVERSEPL")

class Strategy563Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [563 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
