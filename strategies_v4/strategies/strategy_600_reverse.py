# strategy_600_reverse.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_600_reverse")

# 🔸 Класс стратегии
class Strategy600Reverse:
