# strategy_812_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_812_long")

class Strategy812Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[812_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_812_universal_longonly")
