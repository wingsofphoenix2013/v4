# strategy_750_reverse.py — простая транзитная стратегия: без LAB, без фильтра направления
...
# 🔸 Логгер
log = logging.getLogger("strategy_750_reverse")

# 🔸 Класс стратегии
class Strategy750Reverse:
