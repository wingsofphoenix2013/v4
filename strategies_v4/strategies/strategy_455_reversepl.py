# strategy_455_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_455_REVERSEPL")

class Strategy455Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [455 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
            ...
            if direction == "long":
                ...
                if price > ema21 and rsi <= 70 and dmi_gap >= 5:
                    return True
                return ("ignore", f"фильтр long не пройден: price={price}, ema21={ema21}, rsi={rsi}, gap={dmi_gap}")

            elif direction == "short":
                dmi_gap = minus_di - plus_di
                if price < ema21 and rsi >= 30 and dmi_gap >= 5:
                    return True
                return ("ignore", f"фильтр short не пройден: price={price}, ema21={ema21}, rsi={rsi}, gap={dmi_gap}")
