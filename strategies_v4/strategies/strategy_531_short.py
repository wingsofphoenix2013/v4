...
log = logging.getLogger("strategy_531_short")

class Strategy531Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[531_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_531_short")
