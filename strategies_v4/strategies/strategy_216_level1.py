...
log = logging.getLogger("STRATEGY_216_LEVEL1")

class Strategy216Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[216] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[216:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_216_level1")
