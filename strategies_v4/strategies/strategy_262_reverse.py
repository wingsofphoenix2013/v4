# strategy_262_reverse.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_262_REVERSE")

class Strategy262Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [262 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
