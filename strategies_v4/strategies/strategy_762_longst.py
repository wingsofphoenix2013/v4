...
log = logging.getLogger("strategy_762_longst")

class Strategy762Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[762_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_762_longst")
