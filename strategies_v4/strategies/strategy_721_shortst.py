...
log = logging.getLogger("strategy_721_shortst")

class Strategy721Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[721_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_721_shortst")
