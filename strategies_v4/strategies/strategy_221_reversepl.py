# strategy_221_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_221_REVERSEPL")

class Strategy221Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [221 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
