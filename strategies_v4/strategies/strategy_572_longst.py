...
log = logging.getLogger("strategy_572_longst")

class Strategy572Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[572_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_572_longst")
