...
log = logging.getLogger("STRATEGY_356_LEVEL2")

class Strategy356Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[356] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[356:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_356_level2")
