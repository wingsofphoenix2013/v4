...
log = logging.getLogger("strategy_631_shortst")

class Strategy631Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[631_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_631_shortst")
