# strategy_224_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_224_long")

class Strategy224Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[224_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_224_long")
