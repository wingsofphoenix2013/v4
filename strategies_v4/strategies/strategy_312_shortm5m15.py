# strategy_312_shortm5m15.py — зеркальная стратегия (шорт; laboratory_v4 TF: m5m15; таймаут ожидания 90с; INFO-логи; запись ignore в signal_log_queue)
...
# 🔸 Логгер стратегии
log = logging.getLogger("strategy_312_shortm5m15")

# 🔸 Класс стратегии
class Strategy312Shortm5m15:
