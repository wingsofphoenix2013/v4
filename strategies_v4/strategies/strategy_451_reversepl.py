# strategy_451_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_451_REVERSEPL")

class Strategy451Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [451 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
