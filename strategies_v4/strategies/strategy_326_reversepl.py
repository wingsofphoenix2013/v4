# strategy_326_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_326_REVERSEPL")

class Strategy326Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [326 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
