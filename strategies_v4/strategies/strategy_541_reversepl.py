# strategy_541_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_541_REVERSEPL")

class Strategy541Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [541 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}")
