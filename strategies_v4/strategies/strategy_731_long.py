...
log = logging.getLogger("strategy_731_long")

class Strategy731Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[731_LONG] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_731_long")
