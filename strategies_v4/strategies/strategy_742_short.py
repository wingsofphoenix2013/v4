...
log = logging.getLogger("strategy_742_short")

class Strategy742Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[742_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_742_short")
