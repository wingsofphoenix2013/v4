...
log = logging.getLogger("strategy_671_longst")

class Strategy671Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[671_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_671_longst")
