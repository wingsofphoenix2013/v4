...
log = logging.getLogger("strategy_690_universalst")

class Strategy690Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Необработанная ошибка в strategy_690_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [690] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [690] Ошибка при отправке сигнала: {e}")