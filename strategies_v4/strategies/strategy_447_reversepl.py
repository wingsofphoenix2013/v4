# strategy_447_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_447_REVERSEPL")

class Strategy447Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [447 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
