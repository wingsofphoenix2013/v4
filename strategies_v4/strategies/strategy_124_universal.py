# strategy_124_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_124_universal")

class Strategy124Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[124] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_124_level1")
