...
log = logging.getLogger("strategy_842_shortst")

class Strategy842Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[842_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_842_shortst")
