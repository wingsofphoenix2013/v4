# strategy_544_reverse.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_544_REVERSE")

class Strategy544Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [544 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
