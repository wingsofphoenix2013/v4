# strategy_651_shortemapatm15.py — стратегия: разрешение по EMA-паттернам (только m15, short)
...
log = logging.getLogger("strategy_651_shortemapatm15")

REQUEST_STREAM  = "decision_request"
RESPONSE_STREAM = "decision_response"
DECISION_TIMEOUT_MS = 60000  # мс
...
async def _ask_ema_m15_decision(redis, strategy_id: int, symbol: str, direction: str) -> tuple[str, str]:
    ...
    payload = {
        ...
        "mirror": "auto",
        "checks": json.dumps([{"kind": "ema_pattern", "timeframes": ["m15"], "source": "on_demand"}]),
...
class Strategy651Shortemapatm15:
