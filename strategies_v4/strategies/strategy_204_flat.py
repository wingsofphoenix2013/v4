# strategy_204_flat.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_204_FLAT")

class Strategy204Flat:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [204 FLAT] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}, adx={adx}")
