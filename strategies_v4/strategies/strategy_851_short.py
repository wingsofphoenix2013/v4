...
log = logging.getLogger("strategy_851_short")

class Strategy851Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[851_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_851_short")
