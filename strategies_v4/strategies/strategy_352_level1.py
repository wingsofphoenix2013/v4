# strategy_352_level1.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_352_LEVEL1")

class Strategy352Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[352] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.exception("❌ Ошибка в strategy_352_level1")
