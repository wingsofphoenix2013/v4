# strategy_452_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_452_FREVERSEPLUS")

class Strategy452Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [402 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
