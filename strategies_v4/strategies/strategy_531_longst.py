...
log = logging.getLogger("strategy_531_longst")

class Strategy531Longst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[531_LONGST] price={price}, bb_center={bb_center}, bb_lower={bb_lower}")
            ...
            log.exception("❌ Ошибка в strategy_531_longst")
