# strategy_452_reversepl.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_452_REVERSEPL")

class Strategy452Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [452 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
            ...
            if direction == "long":
                ...
                if price > ema21 and rsi > 50 and dmi_gap >= 5:
                    return True
