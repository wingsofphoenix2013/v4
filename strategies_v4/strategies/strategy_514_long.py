# strategy_514_long.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_514_long")

class Strategy514Long:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[514_LONGONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_514_universal_longonly")
