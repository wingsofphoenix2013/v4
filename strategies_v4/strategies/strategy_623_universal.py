# strategy_623_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_623_universal")

class Strategy623Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[623] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_623_level1")
