...
log = logging.getLogger("strategy_851_universalst")

class Strategy851Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Ошибка в strategy_851_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [851] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [851] Ошибка при отправке сигнала: {e}")