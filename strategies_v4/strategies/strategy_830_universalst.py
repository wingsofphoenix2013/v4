...
log = logging.getLogger("strategy_830_universalst")

class Strategy830Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Ошибка в strategy_830_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [830] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [830] Ошибка при отправке сигнала: {e}")