# strategy_614_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_614_universal")

class Strategy614Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[614] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_614_level1")
