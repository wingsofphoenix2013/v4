# strategy_201_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_201_REVERSEPL")

class Strategy201Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [201 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
