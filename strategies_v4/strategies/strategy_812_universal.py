# strategy_812_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_812_universal")

class Strategy812Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[812] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_812_level1")
