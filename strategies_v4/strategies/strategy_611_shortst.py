...
log = logging.getLogger("strategy_611_shortst")

class Strategy611Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[611_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_611_shortst")
