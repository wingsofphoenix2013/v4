# strategy_821_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_821_short")

class Strategy821Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[821_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_821_universal_shortonly")
