# strategy_308_reversepl.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_308_REVERSEPL")

class Strategy308Reversepl:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [308 REVERSEPL] symbol={symbol}, direction={direction}, tf={tf}, "
