...
log = logging.getLogger("strategy_841_short")

class Strategy841Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[841_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_841_short")
