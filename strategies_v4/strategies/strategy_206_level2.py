...
log = logging.getLogger("STRATEGY_206_LEVEL2")

class Strategy206Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[206] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[206:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_206_level2")
