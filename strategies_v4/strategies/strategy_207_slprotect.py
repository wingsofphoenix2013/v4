# strategy_207_slprotect.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_207_SLPROTECT")

class Strategy207Slprotect:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [207 SLPROTECT] symbol={symbol}, direction={direction}, tf={tf}, "
            ...
            if direction == "long":
                ...
                if rsi < 28 and mfi < 25 and price < bb_limit:
                    return True
                ...
                if rsi > 72 and mfi > 75 and price > bb_limit:
                    return True
