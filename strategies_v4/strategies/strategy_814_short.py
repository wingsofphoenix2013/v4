# strategy_814_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_814_short")

class Strategy814Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[814_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_814_universal_shortonly")
