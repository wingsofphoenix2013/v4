# strategy_567_reverse.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_567_REVERSE")

class Strategy567Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [567 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, "
