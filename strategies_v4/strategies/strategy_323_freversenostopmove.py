# strategy_323_freversenostopmove.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_323_FREVERSENOSTOPMOVE")

class Strategy323Freversenostopmove:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [223 FREVERSENOSTOPMOVE] symbol={symbol}, direction={direction}, tf={tf}, "
