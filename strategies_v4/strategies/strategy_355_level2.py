...
log = logging.getLogger("STRATEGY_355_LEVEL2")

class Strategy355Level2:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[355] symbol={symbol}, tf={tf}, direction={direction}, price={price}, adx={adx}, rsi={rsi}")
            ...
            log.debug(f"[355:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_355_level2")
