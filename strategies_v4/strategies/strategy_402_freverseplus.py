# strategy_402_freverseplus.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("STRATEGY_402_FREVERSEPLUS")

class Strategy402Freverseplus:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [202 FREVERSEPLUS] symbol={symbol}, direction={direction}, tf={tf}, "
