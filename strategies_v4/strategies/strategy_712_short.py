# strategy_712_short.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_712_short")

class Strategy712Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[712_SHORTONLY] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_712_universal_shortonly")
