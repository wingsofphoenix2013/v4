# strategy_651_longadx14m15.py — стратегия: разрешение по ADX (m15, length=14) через универсальный решатель
...
log = logging.getLogger("strategy_651_longadx14m15")
