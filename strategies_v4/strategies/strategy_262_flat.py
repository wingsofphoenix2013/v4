# strategy_262_flat.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_262_FLAT")

class Strategy262Flat:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [262 FLAT] symbol={symbol}, direction={direction}, tf={tf}, rsi={rsi}, mfi={mfi}")
