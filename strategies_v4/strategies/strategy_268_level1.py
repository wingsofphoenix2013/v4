...
log = logging.getLogger("STRATEGY_268_LEVEL1")

class Strategy268Level1:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[268] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.debug(f"[268:CANDLE] time={t_ms}, open={open_val}, close={close_val}")
            ...
            log.exception("❌ Ошибка в strategy_268_level1")
