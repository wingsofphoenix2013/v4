# strategy_524_reverse.py

import logging
import json
from infra import load_indicators

log = logging.getLogger("STRATEGY_524_REVERSE")

class Strategy524Reverse:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"🔍 [524 REVERSE] symbol={symbol}, direction={direction}, tf={tf}, adx={adx}, rsi={rsi}")
