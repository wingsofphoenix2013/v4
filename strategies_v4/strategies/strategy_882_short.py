...
log = logging.getLogger("strategy_882_short")

class Strategy882Short:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[882_SHORT] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_882_short")
