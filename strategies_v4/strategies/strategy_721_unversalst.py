...
log = logging.getLogger("strategy_721_universalst")

class Strategy721Universalst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.exception("❌ Ошибка в strategy_721_universalst")
    ...
    async def run(self, signal, context):
        ...
        try:
            ...
            log.debug(f"📤 [721] Сигнал отправлен: {payload}")
        except Exception as e:
            log.warning(f"⚠️ [721] Ошибка при отправке сигнала: {e}")