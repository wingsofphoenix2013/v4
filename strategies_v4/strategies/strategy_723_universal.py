# strategy_723_universal.py

import logging
import json
from infra import load_indicators, get_price

log = logging.getLogger("strategy_723_universal")

class Strategy723Universal:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[723] symbol={symbol}, tf={tf}, direction={direction}, price={price}, "
            ...
            log.exception("❌ Ошибка в strategy_723_level1")
