...
log = logging.getLogger("strategy_681_shortst")

class Strategy681Shortst:
    async def validate_signal(self, signal, context):
        ...
        try:
            ...
            log.debug(f"[681_SHORTST] price={price}, bb_center={bb_center}, bb_upper={bb_upper}")
            ...
            log.exception("❌ Ошибка в strategy_681_shortst")
