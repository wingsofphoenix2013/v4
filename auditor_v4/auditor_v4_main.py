...
async def main():
    ...
    await asyncio.gather(
        ...
        loop_with_interval(run_emasnapshot_worker, "EMASNAPSHOT_WORKER", 120, initial_delay=90),
        loop_with_interval(run_snapshot_aggregator, "SNAPSHOT_AGGREGATOR", 30, initial_delay=180),
