...
#         run_safe_loop(fix_single_ts_point, "REDIS_TS_FIX_ONE"),
        ...
        loop_with_interval(run_audit_all_symbols, "OHLCV_AUDITOR", 7200, initial_delay=120),
        loop_with_interval(fix_missing_candles, "OHLCV_FIXER", 7200, initial_delay=180),
        loop_with_interval(fix_missing_ts_points, "REDIS_TS_FIXER", 600, initial_delay=240),
