# packs/rsi_bin.py — pack-воркер: бинирование RSI по статичному словарю bt_analysis_bins_dict
...
# 🔸 Pack-воркер RSI binning
class RsiBinPack:
    # 🔸 Конструктор
    def __init__(self):
        self.log = logging.getLogger("PACK_RSI_BIN")
