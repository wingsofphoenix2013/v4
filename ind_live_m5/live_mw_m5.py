# live_mw_m5.py — live-расчёт MW m5 (trend/volatility/momentum/extremes + mom_align) с использованием L1; публикация «минимального» JSON в ind_mw_live:* (state + open_time; для trend — direction/strong; для volatility — atr_pct; для mom_align — aligned/countertrend/flat)
